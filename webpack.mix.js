...
//exemplo: console.log(process.env.npm_config_<VARIAVEL>);
const admin = process.env.npm_config_admin;
if (!admin) {
    mix.copyDirectory("resources/views/Client/assets/images", "public/images")
        //COMPILED
