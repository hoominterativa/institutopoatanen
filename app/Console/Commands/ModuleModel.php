...
class ModuleModel extends Command
{
     ...
     * @var string
     */
    protected $signature = 'module:model {module : Enter the name of the module for resource creation}
    ...
    public function handle()
    {
        ...
        try {
            ...
            if($options['admin']){
                ...
                Artisan::call('make:seeder '.$arguments['code'].$arguments['module'].'Seeder');
                Artisan::call('make:factory '.$arguments['code'].$arguments['module'].'Factory --model='.$arguments['code'].$arguments['module']);
            }
