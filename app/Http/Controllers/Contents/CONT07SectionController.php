...
class CONT07SectionController extends Controller
{
     ...
     *
     * @param  \Illuminate\Http\Request  $request
     * @param  \App\Models\Contents\CONT07ContentsSection  $CONT07ContentsSection
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, CONT07ContentsSection $CONT07ContentsSection)
    {
        $data = $request->all();
        $helper = new HelperArchive();
        ...
        if($path_image_desktop){
            storageDelete($CONT07ContentsSection, 'path_image_desktop');
        ...
        if($path_image_mobile){
            storageDelete($CONT07ContentsSection, 'path_image_mobile');
