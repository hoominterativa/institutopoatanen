...
class SERV01AdvantageSectionController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(SERV01ServicesAdvantageSection $SERV01ServicesAdvantageSection)
    {
        //
    }
    ...
    public function update(Request $request, SERV01ServicesAdvantageSection $SERV01ServicesAdvantageSection)
    {
        ...
        $path_image = $helper->optimizeImage($request, 'path_image', $path, 200, 80);
        if($path_image){
            storageDelete($SERV01ServicesAdvantageSection, 'path_image');
        ...
        */
        ...
        if($path_archive){
            storageDelete($SERV01ServicesAdvantageSection, 'path_archive');
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(SERV01ServicesAdvantageSection $SERV01ServicesAdvantageSection)
    {
        //storageDelete($SERV01ServicesAdvantageSection, 'path_image');
        //storageDelete($SERV01ServicesAdvantageSection, 'path_archive');

        if($SERV01ServicesAdvantageSection->delete()){
    ...
    public function destroySelected(Request $request)
    {
        ...
        $SERV01ServicesAdvantageSections = SERV01ServicesAdvantageSection::whereIn('id', $request->deleteAll)->get();
        foreach($SERV01ServicesAdvantageSections as $SERV01ServicesAdvantageSection){
            storageDelete($SERV01ServicesAdvantageSection, 'path_image');
            storageDelete($SERV01ServicesAdvantageSection, 'path_archive');
        }
        */

        if($deleted = SERV01ServicesAdvantageSection::whereIn('id', $request->deleteAll)->delete()){
    ...
    */
    ...
    public function sorting(Request $request)
    {
        foreach($request->arrId as $sorting => $id){
            SERV01ServicesAdvantageSection::where('id', $id)->update(['sorting' => $sorting]);
        }
     ...
     * @return \Illuminate\Http\Response
     */
    //public function show(SERV01ServicesAdvantageSection $SERV01ServicesAdvantageSection)
