...
class SERV01PortfolioSectionController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(SERV01ServicesPortfolioSection $SERV01ServicesPortfolioSection)
    {
        //
    }
    ...
    public function update(Request $request, SERV01ServicesPortfolioSection $SERV01ServicesPortfolioSection)
    {
        ...
        $path_image = $helper->optimizeImage($request, 'path_image', $path, 200, 80);
        if($path_image){
            storageDelete($SERV01ServicesPortfolioSection, 'path_image');
        ...
        */
        ...
        if($path_archive){
            storageDelete($SERV01ServicesPortfolioSection, 'path_archive');
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(SERV01ServicesPortfolioSection $SERV01ServicesPortfolioSection)
    {
        //storageDelete($SERV01ServicesPortfolioSection, 'path_image');
        //storageDelete($SERV01ServicesPortfolioSection, 'path_archive');

        if($SERV01ServicesPortfolioSection->delete()){
    ...
    public function destroySelected(Request $request)
    {
        ...
        $SERV01ServicesPortfolioSections = SERV01ServicesPortfolioSection::whereIn('id', $request->deleteAll)->get();
        foreach($SERV01ServicesPortfolioSections as $SERV01ServicesPortfolioSection){
            storageDelete($SERV01ServicesPortfolioSection, 'path_image');
            storageDelete($SERV01ServicesPortfolioSection, 'path_archive');
        }
        */

        if($deleted = SERV01ServicesPortfolioSection::whereIn('id', $request->deleteAll)->delete()){
    ...
    */
    ...
    public function sorting(Request $request)
    {
        foreach($request->arrId as $sorting => $id){
            SERV01ServicesPortfolioSection::where('id', $id)->update(['sorting' => $sorting]);
        }
     ...
     * @return \Illuminate\Http\Response
     */
    //public function show(SERV01ServicesPortfolioSection $SERV01ServicesPortfolioSection)
