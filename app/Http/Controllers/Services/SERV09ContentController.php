...
class SERV09ContentController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(SERV09ServicesContent $SERV09ServicesContent)
    {
        //
    }
    ...
    public function update(Request $request, SERV09ServicesContent $SERV09ServicesContent)
    {
        ...
        $path_image = $helper->optimizeImage($request, 'path_image', $this->path, null,100);
        if($path_image){
            storageDelete($SERV09ServicesContent, 'path_image');
        ...
        */
        ...
        if($path_archive){
            storageDelete($SERV09ServicesContent, 'path_archive');
    ...
    public function destroySelected(Request $request)
    {
        ...
        $SERV09ServicesContents = SERV09ServicesContent::whereIn('id', $request->deleteAll)->get();
        foreach($SERV09ServicesContents as $SERV09ServicesContent){
            storageDelete($SERV09ServicesContent, 'path_image');
            storageDelete($SERV09ServicesContent, 'path_archive');
        }
        */
    ...
    */
     ...
     * @return \Illuminate\Http\Response
     */
    //public function show(SERV09ServicesContent $SERV09ServicesContent)
