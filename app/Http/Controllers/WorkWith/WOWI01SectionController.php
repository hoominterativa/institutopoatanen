...
class WOWI01SectionController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(WOWI01WorkWithSection $WOWI01WorkWithSection)
    {
        //
    }
    ...
    public function update(Request $request, WOWI01WorkWithSection $WOWI01WorkWithSection)
    {
        ...
        $path_image = $helper->optimizeImage($request, 'path_image', $path, 200, 80);
        if($path_image){
            storageDelete($WOWI01WorkWithSection, 'path_image');
        ...
        */
        ...
        if($path_archive){
            storageDelete($WOWI01WorkWithSection, 'path_archive');
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(WOWI01WorkWithSection $WOWI01WorkWithSection)
    {
        //storageDelete($WOWI01WorkWithSection, 'path_image');
        //storageDelete($WOWI01WorkWithSection, 'path_archive');

        if($WOWI01WorkWithSection->delete()){
    ...
    public function destroySelected(Request $request)
    {
        ...
        $WOWI01WorkWithSections = WOWI01WorkWithSection::whereIn('id', $request->deleteAll)->get();
        foreach($WOWI01WorkWithSections as $WOWI01WorkWithSection){
            storageDelete($WOWI01WorkWithSection, 'path_image');
            storageDelete($WOWI01WorkWithSection, 'path_archive');
        }
        */

        if($deleted = WOWI01WorkWithSection::whereIn('id', $request->deleteAll)->delete()){
    ...
    */
    ...
    public function sorting(Request $request)
    {
        foreach($request->arrId as $sorting => $id){
            WOWI01WorkWithSection::where('id', $id)->update(['sorting' => $sorting]);
        }
     ...
     * @return \Illuminate\Http\Response
     */
    //public function show(WOWI01WorkWithSection $WOWI01WorkWithSection)
