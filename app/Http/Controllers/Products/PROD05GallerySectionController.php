...
class PROD05GallerySectionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        */
        ...
        if(PROD05ProductsGallerySection::create($data)){
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(PROD05ProductsGallerySection $PROD05ProductsGallerySection)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, PROD05ProductsGallerySection $PROD05ProductsGallerySection)
    {
        $data = $request->all();
        ...
        */
        ...
        if($path_archive){
            storageDelete($PROD05ProductsGallerySection, 'path_archive');
        ...
        */
        ...
        if($PROD05ProductsGallerySection->fill($data)->save()){
    ...
    */
     ...
     * @return \Illuminate\Http\Response
     */
    //public function show(PROD05ProductsGallerySection $PROD05ProductsGallerySection)
