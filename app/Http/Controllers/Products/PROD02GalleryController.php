...
class PROD02GalleryController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(PROD02ProductsGallery $PROD02ProductsGallery)
    {
        //
    }
    ...
    public function update(Request $request, PROD02ProductsGallery $PROD02ProductsGallery)
    {
        ...
        */
        ...
        if($path_archive){
            storageDelete($PROD02ProductsGallery, 'path_archive');
    ...
    */
     ...
     * @return \Illuminate\Http\Response
     */
    //public function show(PROD02ProductsGallery $PROD02ProductsGallery)
