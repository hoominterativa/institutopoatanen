...
class COPA04SectionVideoController extends Controller
{
    ...
    public function update(Request $request, COPA04ContentPagesSectionVideo $COPA04ContentPagesSectionVideo)
    {
        ...
        $path_image = $helper->optimizeImage($request, 'path_image', $this->path, null,100);
        if($path_image){
            storageDelete($COPA04ContentPagesSectionVideo, 'path_image');
        ...
        */
        ...
        if($path_archive){
            storageDelete($COPA04ContentPagesSectionVideo, 'path_archive');
    ...
    public function destroySelected(Request $request)
    {
        ...
        $COPA04ContentPagesSectionVideos = COPA04ContentPagesSectionVideo::whereIn('id', $request->deleteAll)->get();
        foreach($COPA04ContentPagesSectionVideos as $COPA04ContentPagesSectionVideo){
            storageDelete($COPA04ContentPagesSectionVideo, 'path_image');
            storageDelete($COPA04ContentPagesSectionVideo, 'path_archive');
        }
        */
