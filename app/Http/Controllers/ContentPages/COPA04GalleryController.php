...
class COPA04galleryController extends Controller
{
    ...
    public function update(Request $request, COPA04ContentPagesgallery $COPA04ContentPagesgallery)
    {
        ...
        $path_image = $helper->optimizeImage($request, 'path_image', $this->path, null,100);
        if($path_image){
            storageDelete($COPA04ContentPagesgallery, 'path_image');
        ...
        */
        ...
        if($path_archive){
            storageDelete($COPA04ContentPagesgallery, 'path_archive');
    ...
    public function destroySelected(Request $request)
    {
        ...
        $COPA04ContentPagesgallerys = COPA04ContentPagesgallery::whereIn('id', $request->deleteAll)->get();
        foreach($COPA04ContentPagesgallerys as $COPA04ContentPagesgallery){
            storageDelete($COPA04ContentPagesgallery, 'path_image');
            storageDelete($COPA04ContentPagesgallery, 'path_archive');
        }
        */

        if($deleted = COPA04ContentPagesgallery::whereIn('id', $request->deleteAll)->delete()){
    ...
    */
    ...
    public function sorting(Request $request)
    {
        foreach($request->arrId as $sorting => $id){
            COPA04ContentPagesgallery::where('id', $id)->update(['sorting' => $sorting]);
        }
