...
use App\Http\Controllers\Blogs\BLOG03GalleriesController;
/**
...
Route::prefix('painel')->middleware('auth')->group(function () use (&$route, $routeName) {
    ...
    //Image
    Route::resource($route . '/imagens', BLOG03GalleriesController::class)->names('admin.' . $routeName . '.images')->parameters(['imagens' => 'BLOG03BlogsGalleries']);
    Route::post($route . '/imagens/delete', [BLOG03GalleriesController::class, 'destroySelectedImages'])->name('admin.' . $routeName . '.images.destroySelected');
    Route::post($route . '/imagens/sorting', [BLOG03GalleriesController::class, 'sortingImages'])->name('admin.' . $routeName . '.images.sorting');
});
// // CLIENT
