                                ...
                                <tr>
                                    <td>
                                        <table align="center" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #767676; color: #000000; width: 680px;"
                                            width="680">
                                            <tbody>
                                                <tr>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <table align="center" border="0" cellpadding="0" cellspacing="0"
                                            class="row-content stack" role="presentation"
                                            style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #dadada; color: #000000; width: 680px;"
                                            width="680">
                                            <tbody>
                                                <tr>
                                                    <td class="column column-1"
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            width="100%">
                                                            <tr>
                                                                <td class="pad" style="width:100%;padding-right:0px;padding-left:0px;padding-top:80px;">
                                                                    <div align="center" class="alignment" style="line-height:10px">
                                                                        <img alt="Bell Icon" src="{{asset('images/bell-icon.png')}}" style="display: block; height: auto; border: 0; width: 92px; max-width: 100%;" width="92" />
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    ...
                                                    <td class="column column-1 last"
                                                        ...
                                                        <div class="border">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class=""
                                                                                ...
                                                                                <p
                                                                                    ...
                                                                                    <span style="font-size:18px;">Recebemos o seu contato!</span>
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class=""
                                                                                ...
                                                                                <p
                                                                                    ...
                                                                                    <span style="font-size:42px;">Obrigado</span>
                                                                                    <span style="font-size:42px;"> </span>
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0"
                                                                ...
                                                                style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;padding-bottom: 80px;"
                                                                width="100%">
                                                                <tr>
                                                                    <td class="pad"
                                                                        ...
                                                                        <div style="font-family: sans-serif">
                                                                            <div class=""
                                                                                ...
                                                                                <p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 24px;">
                                                                                    <span style="font-size:16px;">Olá
                                                                                    <u><strong>{{$name}}</strong></u>,
                                                                                    </span>
                                                                                </p>
                                                                                <p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 24px;">
                                                                                    Agradecemos pelo interesse em nossos serviços, <br>estamos analisando seu contato e <br>em breve retonaremos com respostas.
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td class="pad"
                                                                    style="width:100%;padding-right:0px;padding-left:0px;">
                                                                    <div align="center" class="alignment" style="line-height:10px">
                                                                        <img alt="Girls Image" class="fullMobileWidth" src="images/reminder-img.png" style="display: block; height: auto; border: 0; width: 680px; max-width: 100%;" width="680" />
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                @foreach ($socials as $social)
                                                                                    <td style="padding:0 2px 0 2px;">
                                                                                        ...
                                                                                        @switch($social->icon)
                                                                                            @case('mdi-facebook')
                                                                                                <img alt="Facebook" height="32" src="{{asset('images/facebook.png')}}" style="display: block; height: auto; border: 0;" title="Facebook" width="32" />
                                                                                            @break
                                                                                            @case('mdi-instagram')
                                                                                                <img alt="Instagram" height="32" src="{{asset('images/instagram.png')}}" style="display: block; height: auto; border: 0;" title="Instagram" width="32" />
                                                                                            @break
                                                                                            @case('mdi-youtube')
                                                                                                <img alt="YouTube" height="32" src="{{asset('images/youtube.png')}}" style="display: block; height: auto; border: 0;" title="YouTube" width="32" />
                                                                                            @break
                                                                                            @case('mdi-twitter')
                                                                                                <img alt="Twitter" height="32" src="{{asset('images/twitter.png')}}" style="display: block; height: auto; border: 0;" title="Twitter" width="32" />
                                                                                            @break
                                                                                            @case('mdi-linkedin')
                                                                                                <img alt="Linkedin" height="32" src="{{asset('images/linkedin.png')}}" style="display: block; height: auto; border: 0;" title="Linkedin" width="32" />
                                                                                            @break
                                                                                        @endswitch
                                                                                        </a>
                                                                                    </td>
                                                                ...
                                                                <td class="pad">
                                                                    <div style="font-family: sans-serif">
                                                                        <div class=""
                                                                            ...
                                                                            <p
                                                                                style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 16.8px;">
                                                                                <span style="font-size:12px;">{{date('Y')}} {{env('APP_NAME')}} © Todos os direitos reservados</span>
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                </td>
