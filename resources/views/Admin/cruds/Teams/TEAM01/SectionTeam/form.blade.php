@if ($sectionTeam)
    {!! Form::model($sectionTeam, [
        'route' => ['admin.team01.sectionteam.update', $sectionTeam->id],
        'class' => 'parsley-validate',
        'files' => true,
    ]) !!}
    @method('PUT')
@else
    {!! Form::model(null, ['route' => 'admin.team01.sectionteam.store', 'class' => 'parsley-validate', 'files' => true]) !!}
@endif
