                ...
                <div class="container-image-crop">
                    ...
                    <label class="area-input-image-crop" for="inputImage">
                        {!! Form::file('path_image_thumbnail', [
                            ...
                            'data-default-file'=> isset($portal)?($portal->path_image_thumbnail<>''?url('storage/'.$portal->path_image_thumbnail):''):'',
                        ]) !!}
                    </label>
                ...
                <div class="container-image-crop">
                    ...
                    <label class="area-input-image-crop" for="inputImage">
                        {!! Form::file('path_image', [
                            ...
                            'data-box-height'=>'225', // Input height in the form
                            'accept'=>'.jpg,.jpeg,.png,.gif,.bmp,.tiff,.webp',
                            'data-default-file'=> isset($portal)?($portal->path_image<>''?url('storage/'.$portal->path_image):''):'',
                        ]) !!}
                    </label>
                </div><!-- END container image crop -->
            </div>
