<div class="row col-12">
    <div class="card col-12">
        <div class="card-body" id="tooltip-container">
            ...
            <div class="mb-3">
                <div class="d-flex justify-content-start align-items-center">
                    {!! Form::label(null, 'Scripts de Indexação', ['class'=>'form-label']) !!}
                    <span class="ms-1 mb-1" data-bs-original-title="Inserir os scripts de indexação ex: Google Analytics, Facebook Pixel, Google tag Manager, etc" data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top"><i class="mdi mdi-help-circle"></i></span>
                </div>
            ...
            <div class="mb-3">
                <div class="d-flex justify-content-start align-items-center">
                    {!! Form::label(null, 'Outros Scripts', ['class'=>'form-label']) !!}
                    <span class="ms-1 mb-1" data-bs-original-title="Campo reservado para inserir outros scripts que não sejam para indexação" data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top"><i class="mdi mdi-help-circle"></i></span>
                </div>
