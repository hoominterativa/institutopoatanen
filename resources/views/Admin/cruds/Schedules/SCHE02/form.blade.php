            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    <div class="wrapper-links my-2 border px-2 py-3">
                        ...
                        <div class="row">
                            <div class="mb-3">
                                {!! Form::label('title_button_one', 'Título do primeiro botão', ['class' => 'form-label']) !!}
                                {!! Form::text('title_button_one', null, ['class' => 'form-control', 'id' => 'title_button_one']) !!}

                            </div>
                            <div class="col-12 col-sm-8">
                                {!! Form::label(null, 'Link do primeiro botão', ['class' => 'form-label']) !!}
                ...
                <div class="col-12 col-lg-6">
                    <div class="wrapper-links my-2 border px-2 py-3">
                        <ul class="nav nav-pills navtab-bg nav-justified">
                            <li class="nav-item">
                                <a href="#linkPagesTwo" data-bs-toggle="tab" aria-expanded="false" class="nav-link py-1">
                                    <div class="d-flex align-items-center justify-content-center">
                                        Link para página do site
                                        <i href="javascript:void(0)" class="mdi mdi-help-circle font-22 ms-2 btn-icon cloneTypeButton"
                                            data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top"
                            ...
                            <li class="nav-item">
                                <a href="#linkExternalTwo" data-bs-toggle="tab" aria-expanded="true" class="nav-link active">
                                    <div class="d-flex align-items-center justify-content-center">
                                        Link para página externa
                                        <i href="javascript:void(0)" class="mdi mdi-help-circle font-22 ms-2 btn-icon cloneTypeButton"
                                            data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top"
                        ...
                        <div class="tab-content">
                            <div class="tab-pane" id="linkPagesTwo">
                                <div class="row">
                                    <div class="dropdown mb-3 col-12">
                                        {!! Form::label(null, 'Selecione uma página do site', ['class'=>'form-label']) !!}
                                        <button class="form-control dropdown-toggle text-start" type="button" id="dropdownPages" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            ...
                                            @foreach (listPage() as $page)
                                                <li class="dropdown {{$page->dropdown?'dropdown-submenu':''}}">
                                                    ...
                                                    @if ($page->dropdown)
                                                        <ul class="dropdown-menu">
                                                            @foreach ($page->dropdown as $itens)
                                                                <li><a href="{{$itens->route}}" class="dropdown-item" data-bs-toggle="setUrl" data-target-url="#targetUrlTwo">{{$itens->name}}</a></li>
                                                            @endforeach
                                                        </ul>
                                                    @endif
                                                </li>
                            ...
                            <div class="tab-pane show active" id="linkExternalTwo"></div>
                        </div> {{-- END .tab-content --}}
                        <div class="row">
                            <div class="mb-3">
                                {!! Form::label('title_button_two', 'Título do segundo botão ', ['class' => 'form-label']) !!}
                                {!! Form::text('title_button_two', null, ['class' => 'form-control', 'id' => 'title_button_two']) !!}
                            </div>
                            <div class="col-12 col-sm-8">
                                {!! Form::label(null, 'Link do segundo botão', ['class' => 'form-label']) !!}
                                {!! Form::url('link_button_two', (isset($schedule) && isset($schedule->link_button_two) ? getUri($schedule->link_button_two) : null), ['class' => 'form-control', 'parsley-type' => 'url', 'id' => 'targetUrlTwo']) !!}
                            </div>
                            <div class="col-12 col-sm-4">
                                {!! Form::label('target_link_button_two', 'Redirecionar', ['class'=>'form-label']) !!}
                                {!! Form::select('target_link_button_two', ['_self' => 'Na mesma aba', '_blank' => 'Em nova aba'], null, ['class'=>'form-select', 'id'=>'target_link_button_two']) !!}
                            </div>
                        </div>
                    </div> {{-- END ."wrapper-links --}}
                </div>
