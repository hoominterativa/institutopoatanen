@if ($section)
    {!! Form::model($section, [
        'route' => ['admin.sche02.banner.update', $section->id],
...
<div class="row col-12">
    ...
    <div class="col-12 col-lg-6">
        <div class="card card-body" id="tooltip-container">
            ...
            <div class="mb-3">
                <div class="container-image-crop">
                    {!! Form::label('inputImage', 'Logotipo', ['class' => 'form-label']) !!}
                    <small class="ms-2">Dimensões proporcionais mínimas
                    ...
                    <label class="area-input-image-crop" for="inputImage">
                        {!! Form::file('path_image_banner', [
                            ...
                            'accept' => '.jpg,.jpeg,.png,.gif,.bmp,.tiff,.webp',
                            'data-default-file' => isset($section)
                                ? ($section->path_image_banner != ''
                                    ? url('storage/' . $section->path_image_banner)
                                    : '')
                                : '',
                        ]) !!}
                    </label>
