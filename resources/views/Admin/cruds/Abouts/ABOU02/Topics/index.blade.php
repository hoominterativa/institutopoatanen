...
<div class="container-fluid">
    <div id="aboutTopicsList" class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-6">
                            <button id="btSubmitDelete" data-route="{{route('admin.abou02.topic.destroySelected')}}" type="button" class="btn btn-danger btnDeleteAboutTopics" style="display: none;">Deletar selecionados</button>
                        </div>
                        <div class="col-6">
                    ...
                    <table class="table table-bordered table-sortable">
                        ...
                        <tbody data-route="{{route('admin.abou02.topic.sorting')}}">
                            @foreach ($topics as $topic)
                                <tr data-code="{{$topic->id}}">
                                    ...
                                    <td class="align-middle">{!! substr($topic->text, 0, 30) !!}</td>
                                    ...
                                    <td class="align-middle">
                                        <div class="row">
                                            ...
                                            <form action="{{route('admin.abou02.topic.destroy',['ABOU02AboutsTopic' => $topic->id])}}" class="col-4" method="POST">
                                                @method('DELETE') @csrf
