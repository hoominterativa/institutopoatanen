@if (isset($topic))
    {!! Form::model($topic, ['route' => ['admin.abou02.topic.update', $topic->id], 'class'=>'parsley-validate', 'files' => true]) !!}
    @method('PUT')
@else
    {!! Form::model(null, ['route' => ['admin.abou02.topic.store'], 'class'=>'parsley-validate', 'files' => true]) !!}
