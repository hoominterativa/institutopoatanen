                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('admin.abou02.index') }}">{{ getTitleModel($configModelsMain, 'Abouts', 'ABOU02') }}</a>
                                    </li>
                                    <li class="breadcrumb-item active"> {{ getTitleModel($configModelsMain, 'Abouts', 'ABOU02') }}</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Página {{ getTitleModel($configModelsMain, 'Abouts', 'ABOU02') }}</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                ...
                <ul class="mb-0 nav nav-tabs" id="tooltip-container">
                    <li class="nav-item">
                        <a href="#about" data-bs-toggle="tab" aria-expanded="true"
                            ...
                            {{ getTitleModel($configModelsMain, 'Abouts', 'ABOU02') }}
