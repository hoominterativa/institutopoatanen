            ...
            <div class="card card-body" id="tooltip-container">
                <div class="mb-3">
                    <div class="container-image-crop">
                        ...
                        <small class="ms-2">Dimensões proporcionais mínimas {{$cropSetting->path_image_banner_desktop->width}}x{{$cropSetting->path_image_banner_desktop->height}}px!</small>
                        <label class="area-input-image-crop" for="inputImage">
                            {!! Form::file('path_image_banner_desktop', [
                                ...
                                'data-default-file'=> isset($about)?($about->path_image_banner_desktop<>''?url('storage/'.$about->path_image_banner_desktop):''):'',
                            ]) !!}
                        </label>
                    ...
                    <div class="container-image-crop">
                        ...
                        <label class="area-input-image-crop" for="inputImage">
                            {!! Form::file('path_image_banner_mobile', [
                                ...
                                'data-box-height'=>'225', // Input height in the form
                                'accept'=>'.jpg,.jpeg,.png,.gif,.bmp,.tiff,.webp',
                                'data-default-file'=> isset($about)?($about->path_image_banner_mobile<>''?url('storage/'.$about->path_image_banner_mobile):''):'',
                            ]) !!}
                        </label>
                    </div><!-- END container image crop -->
                </div>
