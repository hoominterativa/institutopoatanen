            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Tópicos da página {{$configModelsMain->Abouts->ABOU01->config->titlePanel}}</li>
                    </ol>
                </div>
                <h4 class="page-title">Tópicos da página {{$configModelsMain->Abouts->ABOU01->config->titlePanel}}</h4>
            </div>
        </div>
    </div>
    <!-- end row -->
                                ...
                                <tr data-code="{{$topic->id}}">
                                    ...
                                    <td class="align-middle">
                                        <div class="row">
                                            ...
                                            <form action="{{route('admin.abou01.topic.destroy',['ABOU01AboutsTopics' => $topic->id])}}" class="col-4" method="POST">
                                                @method('DELETE') @csrf
