        ...
        <div class="card">
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-6">
                        <button id="btSubmitDelete"
                            data-route="{{ route('admin.abou04.gallery.destroySelected') }}" type="button" class="btn btn-danger btDeleteGalleries" style="display: none;">Deletar selecionados</button>
                    </div>
                    <div class="col-6">
                        ...
                        <a href="javascript:void(0)" data-bs-target="#modal-sectionGallery-create" data-bs-toggle="modal" class="btn btn-warning float-end me-2">Informações adicionais <i class="mdi mdi-plus"></i></a>
                    </div>
                </div>
                <table class="table table-bordered table-sortable">
                    ...
                    <tbody data-route="{{ route('admin.abou04.gallery.sorting') }}">
                            ...
                            <tr data-code="{{ $gallery->id }}">
                                ...
                                <td class="align-middle">
                                    <div class="row">
                                        ...
                                        <form action="{{ route('admin.abou04.gallery.destroy', ['ABOU04AboutsGallery' => $gallery->id]) }}" class="col-4" method="POST">
                                            @method('DELETE') @csrf
...
<div id="modal-sectionGallery-create" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" style="max-width: 900px;">
        <div class="modal-content">
            <div class="modal-header p-3 pt-2 pb-2">
            ...
            <div class="modal-body p-3 pt-0 pb-3">
                @include('Admin.cruds.Abouts.ABOU04.Gallery.Section.form', [
