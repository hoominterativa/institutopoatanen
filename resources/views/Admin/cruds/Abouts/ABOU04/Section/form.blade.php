@if ($section)
    {!! Form::model($section, ['route' => ['admin.abou04.section.update', $section->id], 'class'=>'parsley-validate', 'method'=>'PUT', 'files'=>true]) !!}
@else
        ...
        <div class="card card-body" id="tooltip-container">
            ...
            <div class="wrapper-links my-2 border px-2 py-3">
                <ul class="nav nav-pills navtab-bg nav-justified">
                    <li class="nav-item">
                        <a href="#linkPagess01" data-bs-toggle="tab" aria-expanded="false" class="nav-link py-1">
                    ...
                    <li class="nav-item">
                        <a href="#linkExternall01" data-bs-toggle="tab" aria-expanded="true" class="nav-link active">
                            <div class="d-flex align-items-center justify-content-center">
                ...
                <div class="tab-content">
                    <div class="tab-pane" id="linkPagess01">
                        <div class="row">
                    ...
                    <div class="tab-pane show active" id="linkExternall01"></div>
                </div> {{-- END .tab-content --}}
                <div class="row">
        ...
        <div class="card card-body" id="tooltip-container">
            <div class="mb-3">
                <div class="container-image-crop">
                    ...
                    <small class="ms-2">Dimensões proporcionais mínimas {{$cropSetting->Section->path_image->width}}x{{$cropSetting->Section->path_image->height}}px!</small>
