                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-6">
                                        <button id="btSubmitDelete" data-route="{{ route('admin.bran01.destroySelected') }}"
                                            type="button" class="btn btn-danger btnDeleteBrands"
                                            ...
                                            <tr data-code="{{ $brand->id }}">
                                                ...
                                                <td class="align-middle avatar-group">
                                                    <div class="avatar-group-item avatar-bg rounded-circle avatar-sm"
                                                        style="background-image: url({{ asset('Admin/assets/' . $brand->path_image_icon) }})">
                                                    </div>
                                                </td>
