@if (isset($category))
    {!! Form::model($category, ['route' => ['admin.prod02v1.category.update', $category->id], 'class'=>'parsley-validate', 'files' => true]) !!}
    @method('PUT')
@else
    {!! Form::model(null, ['route' => ['admin.prod02v1.category.store'], 'class'=>'parsley-validate', 'files' => true]) !!}
@endif
    <div class="row">
