@if (isset($category))
    {!! Form::model($category, ['route' => ['admin.prod05.category.update', $category->id], 'class'=>'parsley-validate', 'files' => true]) !!}
    @method('PUT')
@else
    {!! Form::model(null, ['route' => ['admin.prod05.category.store'], 'class'=>'parsley-validate', 'files' => true]) !!}
@endif
    <div class="row">
        <div class="col-12 col-lg-6 ">
            <div class="card card-body border" id="tooltip-container">
                <div class="mb-3">
                    {!! Form::label('title', 'Título da categoria', ['class'=>'form-label']) !!}
        ...
        <div class="col-12 col-lg-6 ">
            <div class="card card-body border" id="tooltip-container">
                <div class="mb-3">
                    {!! Form::label('title_section', 'Título Interno', ['class'=>'form-label']) !!}
                    {!! Form::text('title_section', null, ['class'=>'form-control', 'id'=>'title_section']) !!}
                </div>
                <div class="mb-3">
                    {!! Form::label('subtitle_section', 'Subtítulo Interno', ['class'=>'form-label']) !!}
                    {!! Form::text('subtitle_section', null, ['class'=>'form-control', 'id'=>'subtitle_section']) !!}
                </div>
                <div class="basic-editor__content mb-3">
                    {!! Form::label('description_section', 'Descrição Interna', ['class'=>'form-label']) !!}
