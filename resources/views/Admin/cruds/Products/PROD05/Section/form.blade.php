@if ($section)
    {!! Form::model($section, ['route' => ['admin.prod05.section.update', $section->id], 'class' => 'parsley-validate', 'files' => true,]) !!}
    @method('PUT')
@else
    {!! Form::model(null, ['route' => 'admin.prod05.section.store', 'class' => 'parsley-validate', 'files' => true]) !!}
@endif
