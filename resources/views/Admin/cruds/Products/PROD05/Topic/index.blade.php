    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-6">
                        <button id="btSubmitDelete" data-route="{{route('admin.prod05.topic.destroySelected')}}" type="button" class="btn btn-danger btnDeleteTopic" style="display: none;">Deletar selecionados</button>
                    </div>
                    <div class="col-6">
                        <a href="javascript:void(0)"  data-bs-target="#modal-topic-create" data-bs-toggle="modal" class="btn btn-success float-end">Adicionar Tópico <i class="mdi mdi-plus"></i></a>
                    </div>
                </div>
                <table class="table table-bordered table-sortable">
                    ...
                    <tbody data-route="{{route('admin.prod05.topic.sorting')}}">
                        @foreach ($topics as $topic)
                            <tr data-code="{{$topic->id}}">
                                ...
                                <td class="align-middle">{{$topic->category_title}}</td>
                                <td class="align-middle">{{$topic->title}}</td>
                                <td class="align-middle">{{substr(strip_tags($topic->text), 0, 100)}}</td>
                                ...
                                <td class="align-middle">
                                    <div class="row">
                                        ...
                                        <form action="{{route('admin.prod05.topic.destroy',['PROD05ProductsTopic' => $topic->id])}}" class="col-4" method="POST">
                                            @method('DELETE') @csrf
                                        ...
                                        <div class="modal-dialog" style="max-width: 1100px;">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body p-3 pt-0 pb-3">
                                                    @include('Admin.cruds.Products.PROD05.Topic.form',[
