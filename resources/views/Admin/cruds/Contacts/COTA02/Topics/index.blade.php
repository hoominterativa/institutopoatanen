    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-6">
                        <button id="btSubmitDelete" data-route="{{route('admin.cota02.topic.destroySelected')}}" type="button" class="btn btn-danger btnDeleteTopic" style="display: none;">Deletar selecionados</button>
                    </div>
                    <div class="col-6">
                ...
                <table class="table table-bordered table-sortable">
                    ...
                    <tbody data-route="{{route('admin.cota02.topic.sorting')}}">
                            ...
                            <tr data-code="{{$topic->id}}">
                                ...
                                <td class="align-middle">
                                    <div class="row">
                                        ...
                                        <form action="{{route('admin.cota02.topic.destroy',['COTA02ContactsTopic' => $topic->id])}}" class="col-4" method="POST">
                                            @method('DELETE') @csrf
                                            ...
                                            <div class="modal-dialog" style="max-width: 900px;">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body p-3 pt-0 pb-3">
                                                        @include('Admin.cruds.Contacts.COTA02.Topics.form',[
                                                            'topic' => $topic
                                                        ])
                                                    </div>
                                                </div>
