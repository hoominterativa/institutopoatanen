            ...
            <div class="container-fluid">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane show active" id="infoContact">
                        {!! Form::model($contact, [
                            'route' => ['admin.cota04.update', $contact->id],
                        ...
                        <a href="{{ route('admin.cota04.index') }}"
                    ...
                    {{-- <div class="tab-pane" id="banner">
                        ...
                        @include('Admin.cruds.Contacts.COTA04.Banner.form')
                        {!! Form::close() !!}
                    </div>
                    <div class="tab-pane" id="content">
                        ...
                        {!! Form::hidden('title_banner', $contact->title_banner) !!}
                        @include('Admin.cruds.Contacts.COTA04.Content.form')
                        {!! Form::close() !!}
                    </div>
                    <div class="tab-pane" id="infoForm">
                        ...
                        {!! Form::hidden('title_banner', $contact->title_banner) !!}
                        @include('Admin.cruds.Contacts.COTA04.InfoForm.form')
                        {!! Form::close() !!}
                    </div> --}}
                </div> <!-- container -->
            </div>
