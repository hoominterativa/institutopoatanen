                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Editar {{$configModelsMain->Contacts->COTA01->config->titlePanel}}</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Editar {{$configModelsMain->Contacts->COTA01->config->titlePanel}}</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                ...
                <ul class="mb-0 nav nav-tabs" id="tooltip-container">
                    <li class="nav-item">
                        <a href="#infoFormContact" data-bs-toggle="tab" aria-expanded="true" class="nav-link active  d-flex align-items-center">
                            ...
                            <i href="javascript:void(0)" class="mdi mdi-help-circle font-20 ms-2 btn-icon cloneTypeButton"
