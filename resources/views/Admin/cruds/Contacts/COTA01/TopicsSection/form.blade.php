        ...
        <div class="col-12">
            ...
            <div class="mb-3">
                <div class="container-image-crop">
                    ...
                    <small class="ms-2">Dimensões proporcionais mínimas {{$cropSetting->TopicSection->path_image_icon->width}}x{{$cropSetting->TopicSection->path_image_icon->height}}px!</small>
