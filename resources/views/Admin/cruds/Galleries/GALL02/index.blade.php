            ...
            <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">{{getTitleModel($configModelsMain, 'Galleries', 'GALL02')}}</li>
                                </ol>
                            </div>
                            <h4 class="page-title">{{getTitleModel($configModelsMain, 'Galleries', 'GALL02')}}</h4>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                ...
                <div class="tab-content">
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row mb-3">
                                            <div class="col-6">
                                                <button id="btSubmitDelete" data-route="{{route('admin.gall02.destroySelected')}}" type="button" class="btn btn-danger btnDeleteGALL02" style="display: none;">Deletar selecionados</button>
                                            </div>
                                            <div class="col-6">
                                                <a href="{{route('admin.gall02.create')}}" class="btn btn-success float-end">Adicionar novo <i class="mdi mdi-plus"></i></a>
                                            </div>
                                        </div>
                                        <table class="table table-bordered table-sortable">
                                            ...
                                            <tbody data-route="{{route('admin.gall02.sorting')}}">
                                                @foreach ($galleries as $gallery)
                                                    <tr data-code="{{$gallery->id}}">
                                                        ...
                                                        <td class="align-middle">
                                                            <div class="row">
                                                                <div class="col-4">
                                                                    <a href="{{route('admin.gall02.edit',['GALL02Galleries' => $gallery->id])}}" class="btn-icon mdi mdi-square-edit-outline"></a>
                                                                </div>
                                                                <form action="{{route('admin.gall02.destroy',['GALL02Galleries' => $gallery->id])}}" class="col-4" method="POST">
                                                                    @method('DELETE') @csrf
                    ...
                    <div class="tab-pane" id="section">
                        @include('Admin.cruds.Galleries.GALL02.Section.form')
                    </div>
                </div>
                <!-- end row -->
            </div> <!-- container -->
