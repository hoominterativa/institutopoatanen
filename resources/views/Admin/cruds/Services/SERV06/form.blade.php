            ...
            <div class="mb-3">
                {!! Form::label('section', 'Título da seção', ['class' => 'form-label']) !!}
                    <i href="javascript:void(0)" class="mdi mdi-help-circle font-20 ms-2 btn-icon"
                        ...
                        data-bs-original-title="Este título será usado como ancora para os serviços">
                    </i>
                {!! Form::text('section', null, ['class' => 'form-control', 'required' => 'required', 'id' => 'section']) !!}
            </div>
            <div class="mb-3">
                <div class="row">
                    <div class="col-sm-6">
        ...
        <div class="card card-body" id="tooltip-container">
            <div class="mb-3">
                <div class="container-image-crop">
                    {!! Form::label('inputImage', 'Ícone do título da seção', ['class' => 'form-label']) !!}
                    <i href="javascript:void(0)" class="mdi mdi-help-circle font-20 ms-2 btn-icon"
                        data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top"
                        data-bs-original-title="Aqui, você deve cadastrar o ícone para o título da seção"></i>
