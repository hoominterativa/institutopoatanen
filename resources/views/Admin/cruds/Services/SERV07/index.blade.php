                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">{{getTitleModel($configModelsMain, 'Services', 'SERV07')}}</li>
                                </ol>
                            </div>
                            <h4 class="page-title">{{getTitleModel($configModelsMain, 'Services', 'SERV07')}}</h4>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row mb-3">
                                            <div class="col-6">
                                                <button id="btSubmitDelete" data-route="{{route('admin.serv07.destroySelected')}}" type="button" class="btn btn-danger btnDeleteServicos" style="display: none;">Deletar selecionados</button>
                                            </div>
                                            <div class="col-6">
                                                <a href="{{route('admin.serv07.create')}}" class="btn btn-success float-end">Adicionar novo <i class="mdi mdi-plus"></i></a>
                                            </div>
                                        </div>
                                        <table class="table table-bordered table-sortable">
                                            <thead class="table-light">
                                                <tr>
                                                    ...
                                                    <th width="30px" class="bs-checkbox">
                                                        <label><input name="btnSelectAll" value="btnDeleteServicos" type="checkbox"></label>
                                                    </th>
                                                    <th>Imagem</th>
                                                    <th>Categoria</th>
                                            ...
                                            <tbody data-route="{{route('admin.serv07.sorting')}}">
                                                @foreach ($services as $service)
                                                    <tr data-code="{{$service->id}}">
                                                        ...
                                                        <td class="align-middle avatar-group">
                                                            @if ($service->path_image || $service->path_image_box)
                                                        ...
                                                        <td class="align-middle">
                                                            <div class="row">
                                                                <div class="col-4">
                                                                    <a href="{{route('admin.serv07.edit',['SERV07Services' => $service->id])}}" class="btn-icon mdi mdi-square-edit-outline"></a>
                                                                </div>
                                                                <form action="{{route('admin.serv07.destroy',['SERV07Services' => $service->id])}}" class="col-4" method="POST">
                                                                    @method('DELETE') @csrf
