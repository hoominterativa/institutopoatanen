    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-6">
                        <button id="btSubmitDelete" data-route="{{route('admin.serv08.category.destroySelected')}}" type="button" class="btn btn-danger btnDeleteCategory" style="display: none;">Deletar selecionados</button>
                    </div>
                    <div class="col-6">
                ...
                <table class="table table-bordered table-sortable">
                    ...
                    <tbody data-route="{{route('admin.serv08.category.sorting')}}">
                            ...
                            <tr data-code="{{$category->id}}">
                                ...
                                <td class="align-middle">
                                    <div class="row">
                                        ...
                                        <form action="{{route('admin.serv08.category.destroy',['SERV08ServicesCategory' => $category->id])}}" class="col-4" method="POST">
                                            @method('DELETE') @csrf
                                            ...
                                            <div class="modal-dialog" style="max-width: 1100px;">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body p-3 pt-0 pb-3">
                                                        @include('Admin.cruds.Services.SERV08.Category.form',[
                                                            'category' => $category
                                                        ])
                                                    </div>
                                                </div>
