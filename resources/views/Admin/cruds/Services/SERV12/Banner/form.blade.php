@if ($category)
    {!! Form::model($category, ['route' => ['admin.serv12.category.update', $category->id],'class' => 'parsley-validate','files' => true,]) !!}
    @method('PUT')
    {!! Form::hidden('slug', $category->slug) !!}
    {!! Form::hidden('featured', $category->featured) !!}
    {!! Form::hidden('active', $category->active) !!}
@else
    {!! Form::model(null, ['route' => 'admin.serv12.category.store', 'class' => 'parsley-validate', 'files' => true]) !!}
@endif
        ...
        <div class="card card-body" id="tooltip-container">
            <div class="mb-3">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        {!! Form::label('subtitle_banner', 'Título', ['class' => 'form-label']) !!}
                    ...
                    <label class="area-input-image-crop" for="inputImage">
                        {!! Form::file('path_image_desktop_banner', [
                            ...
                            'data-default-file' => isset($category)
                                ? ($category->path_image_desktop_banner != ''
                                    ? url('storage/' . $category->path_image_desktop_banner)
                                    : '')
                                : '',
                        ]) !!}
                    </label>
                ...
                <div class="container-image-crop">
                    ...
                    <label class="area-input-image-crop" for="inputImage">
                        {!! Form::file('path_image_mobile_banner', [
                            ...
                            'accept' => '.jpg,.jpeg,.png,.gif,.bmp,.tiff,.webp',
                            'data-default-file' => isset($category)
                                ? ($category->path_image_mobile_banner != ''
                                    ? url('storage/' . $category->path_image_mobile_banner)
                                    : '')
                                : '',
                        ]) !!}
                    </label>
