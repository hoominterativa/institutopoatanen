                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-6">
                                                <a href="{{route('admin.serv12.create')}}" class="btn btn-success float-end">Adicionar Serviço <i class="mdi mdi-plus"></i></a>
                                            </div>
                                        </div>
                                            ...
                                            <tbody data-route="{{route('admin.serv12.sorting')}}">
                                                @foreach ($services as $service)
                                                    <tr data-code="{{$service->id}}">
                                                        ...
                                                        <td class="align-middle">{{implode(' / ', array_filter([$service->title, $service->subtitle]))}}</td>
                                                        ...
                                                        <td class="align-middle">
                                                            <div class="row">
                                                                <div class="col-4">
                                                                    <a href="{{route('admin.serv12.edit',['SERV12Services' => $service->id])}}" class="btn-icon mdi mdi-square-edit-outline"></a>
                                                                </div>
                                                                <form action="{{route('admin.serv12.destroy',['SERV12Services' => $service->id])}}" class="col-4" method="POST">
                                                                    @method('DELETE') @csrf
