        ...
        <div class="card">
            <div class="card-body">
                ...
                <table class="table table-bordered table-sortable">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th width="30px" class="bs-checkbox">
                                <label><input name="btnSelectAll" value="btnDeleteCategories" type="checkbox"></label>
                            </th>
                            <th>Imagem</th>
                            <th>Título</th>
                    ...
                    <tbody data-route="{{route('admin.serv12.category.sorting')}}">
                        @foreach ($categories as $category)
                            <tr data-code="{{$category->id}}">
                                ...
                                <td class="align-middle">
                                    <div class="row">
                                        <div class="col-4">
                                            <a href="{{route('admin.serv12.category.edit',['SERV12ServicesCategory' => $category->id])}}" class="btn-icon mdi mdi-square-edit-outline"></a>
                                        </div>
                                        <form action="{{route('admin.serv12.category.destroy',['SERV12ServicesCategory' => $category->id])}}" class="col-4" method="POST">
                                            @method('DELETE') @csrf
