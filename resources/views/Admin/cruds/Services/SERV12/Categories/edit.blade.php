                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="{{ route('admin.serv12.index') }}">{{ getTitleModel($configModelsMain, 'Services', 'SERV12') }}</a>
                                    </li>
                    ...
                    <li class="nav-item">
                        <a href="#editCategory" data-bs-toggle="tab" aria-expanded="true" class="nav-link active d-flex align-items-center">
                            ...
                            <i href="javascript:void(0)" class="mdi mdi-help-circle font-20 ms-2 btn-icon"
                                ...
                                data-bs-original-title="Editar categoria"></i>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="#banner" data-bs-toggle="tab" aria-expanded="true" class="nav-link d-flex align-items-center">
                            ...
                            <i href="javascript:void(0)" class="mdi mdi-help-circle font-20 ms-2 btn-icon"
                                data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top"
                                data-bs-original-title="Cadastro dos banners das categorias"></i>
                        </a>
                    </li>
                </ul>
