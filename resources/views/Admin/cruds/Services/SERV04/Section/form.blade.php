...
<div class="tab-pane" id="banner">
    @if ($section)
        {!! Form::model($section, [
            'route' => ['admin.serv04.section.update', $section->id],
                    ...
                    <div class="container-image-crop">
                        ...
                        <label class="area-input-image-crop" for="inputImage">
                            {!! Form::file('path_image_section_desktop', [
                                ...
                                'accept' => '.jpg,.jpeg,.png,.gif,.bmp,.tiff,.webp',
                                'data-default-file' => isset($section)
                                    ? ($section->path_image_section_desktop != ''
                                        ? url('storage/' . $section->path_image_section_desktop)
                                        : '')
                                    : '',
                            ]) !!}
                        </label>
                    ...
                    <div class="container-image-crop">
                        ...
                        <label class="area-input-image-crop" for="inputImage">
                            {!! Form::file('path_image_section_mobile', [
                                ...
                                'accept' => '.jpg,.jpeg,.png,.gif,.bmp,.tiff,.webp',
                                'data-default-file' => isset($section)
                                    ? ($section->path_image_section_mobile != ''
                                        ? url('storage/' . $section->path_image_section_mobile)
                                        : '')
                                    : '',
                            ]) !!}
                        </label>
