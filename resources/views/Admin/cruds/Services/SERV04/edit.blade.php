        ...
        <div class="content">
            ...
            <div class="container-fluid">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item"><a
                                            href="{{ route('admin.serv04.index') }}">{{ getTitleModel($configModelsMain, 'Services', 'SERV04') }}</a>
                                    </li>
                ...
                <ul class="mb-0 nav nav-tabs" id="tooltip-container">
                    <li class="nav-item">
                        <a href="#editService" data-bs-toggle="tab" aria-expanded="true"
                    ...
                    <li class="nav-item">
                        <a href="#topics" data-bs-toggle="tab" aria-expanded="true"
                            ...
                            <i href="javascript:void(0)" class="mdi mdi-help-circle font-20 ms-2 btn-icon"
                                ...
                                data-bs-original-title="Este tópico será exibido na página de serviços"></i>
                        </a>
                    </li>
                </ul>
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="editService">
                        {!! Form::model($service, [
                            'route' => ['admin.serv04.update', $service->id],
                        ...
                        <a href="{{ route('admin.serv04.index') }}"
