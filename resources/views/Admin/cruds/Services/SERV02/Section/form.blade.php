@if ($section)
    {!! Form::model($section, ['route' => ['admin.serv02.section.update', $section->id],'class' => 'parsley-validate', 'files' => true,]) !!}
    @method('PUT')
    {!! Form::hidden('active_banner', $section->active_banner) !!}
@else
    {!! Form::model(null, ['route' => 'admin.serv02.section.store', 'class' => 'parsley-validate', 'files' => true]) !!}
@endif
    ...
    <div class="col-12">
        ...
        <div class="col-12">
            <div class="mb-3 form-check me-3">
                ...
                {!! Form::label('active_section', 'Ativar exibição dos campos?', ['class' => 'form-check-label']) !!}
            </div>
        </div>
    </div>
