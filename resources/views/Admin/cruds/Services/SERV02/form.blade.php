<div class="row col-12">
    ...
    {!! Form::hidden('active_section', isset($service) ? $service->active_section : null) !!}
            ...
            <div class="wrapper-links my-2 border px-2 py-3">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-8">
                        ...
                        {!! Form::url('link_button', isset($service) ? getUri($service->link_button) : null, ['class' => 'form-control', 'parsley-type' => 'url', 'id' => 'targetUrl']) !!}
                    </div>
