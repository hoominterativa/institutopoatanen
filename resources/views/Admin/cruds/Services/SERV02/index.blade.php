            ...
            <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">{{getTitleModel($configModelsMain, 'Services', 'SERV02')}}</li>
                                </ol>
                            </div>
                            <h4 class="page-title">{{getTitleModel($configModelsMain, 'Services', 'SERV02')}}</h4>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                ...
                <div class="tab-content">
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row mb-3">
                                            <div class="col-6">
                                                <button id="btSubmitDelete" data-route="{{route('admin.serv02.destroySelected')}}" type="button" class="btn btn-danger btnDeleteSERV02" style="display: none;">Deletar selecionados</button>
                                            </div>
                                            <div class="col-6">
                                                <a href="{{route('admin.serv02.create')}}" class="btn btn-success float-end">Adicionar novo <i class="mdi mdi-plus"></i></a>
                                            </div>
                                        </div>
                                        <table class="table table-bordered table-sortable">
                                            ...
                                            <tbody data-route="{{route('admin.serv02.sorting')}}">
                                                @foreach ($services as $service)
                                                    <tr data-code="{{$service->id}}">
                                                        ...
                                                        <td class="align-middle">
                                                            <div class="row">
                                                                <div class="col-4">
                                                                    <a href="{{route('admin.serv02.edit',['SERV02Services' => $service->id])}}" class="btn-icon mdi mdi-square-edit-outline"></a>
                                                                </div>
                                                                <form action="{{route('admin.serv02.destroy',['SERV02Services' => $service->id])}}" class="col-4" method="POST">
                                                                    @method('DELETE') @csrf
                    ...
                    <div class="tab-pane" id="section">
                        @include('Admin.cruds.Services.SERV02.Section.form')
                    </div>
                    <div class="tab-pane" id="banner">
                        @include("Admin.cruds.Services.SERV02.Banner.form")
                    </div>
                </div>
                <!-- end row -->
            </div> <!-- container -->
