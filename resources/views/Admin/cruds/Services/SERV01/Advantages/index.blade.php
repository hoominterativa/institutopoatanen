                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-12 mt-3">
                            @if ($advantageSection)
                                {!! Form::model($advantageSection, ['route' => ['admin.serv01.advantage.section.update', $advantageSection->id], 'class'=>'parsley-validate', 'files' => true]) !!}
                                @method('PUT')
                            @else
                                {!! Form::model(null, ['route' => 'admin.serv01.advantage.section.store', 'class'=>'parsley-validate', 'files' => true]) !!}
                            @endif
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-6">
                                            ...
                                            <div class="mb-3 form-check me-3">
                                                {!! Form::checkbox('active', '1', null, ['class'=>'form-check-input', 'id'=>'activeSectionAdvantage']) !!}
                                                {!! Form::label('activeSectionAdvantage', 'Ativar exibição?', ['class'=>'form-check-label']) !!}
                                            </div>
                                        </div>
                                        <div class="col-12 col-lg-6">
                                            <div class="mb-3">
                    ...
                    <table class="table table-bordered table-sortable">
                        ...
                        <tbody data-route="{{route('admin.serv01.advantage.sorting')}}">
                                ...
                                <tr data-code="{{$advantage->id}}">
                                    ...
                                    <td class="align-middle avatar-group">
                                        @if ($advantage->path_image_icon)
                                            <div class="avatar-group-item avatar-bg rounded-circle avatar-sm" style="background-image: url({{asset('storage/'.$advantage->path_image_icon)}})"></div>
                                        @endif
                                        @if ($advantage->path_image)
                                            <div class="avatar-group-item avatar-bg rounded-circle avatar-sm" style="background-image: url({{asset('storage/'.$advantage->path_image)}})"></div>
                                        @endif
                                    </td>
                                    ...
                                    <td class="align-middle">
                                        <div class="row">
                                            <div class="col-4">
                                                <a href="javascript:void(0)" data-bs-target="#modal-advantage-update-{{$advantage->id}}" data-bs-toggle="modal" class="btn-icon mdi mdi-square-edit-outline"></a>
                                            </div>
                                            ...
                                            {{-- BEGIN MODAL ADVANTAGE UPDATE --}}
                                            <div id="modal-advantage-update-{{$advantage->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                                <div class="modal-dialog" style="max-width: 1100px;">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body p-3 pt-0 pb-3">
                                                            @include('Admin.cruds.Services.SERV01.Advantages.form',[
                                                                'service' => $service,
                                                                'advantage' => $advantage
                                                            ])
                                                        </div>
