@if (isset($topic))
    {!! Form::model($topic, ['route' => ['admin.serv05.topic.update', $topic->id], 'class'=>'parsley-validate', 'files' => true]) !!}
    @method('PUT')
@else
    {!! Form::model(null, ['route' => ['admin.serv05.topic.store'], 'class'=>'parsley-validate', 'files' => true]) !!}
