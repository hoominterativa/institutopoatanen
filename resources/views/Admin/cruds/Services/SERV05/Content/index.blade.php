        ...
        <div class="card">
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-6">
                        <button id="btSubmitDelete"
                            data-route="{{ route('admin.serv05.content.destroySelected') }}" type="button" class="btn btn-danger btDeleteContents" style="display: none;">Deletar selecionados</button>
                    </div>
                    <div class="col-6">
                ...
                <table class="table table-bordered table-sortable">
                    ...
                    <tbody data-route="{{ route('admin.serv05.content.sorting') }}">
                            ...
                            <tr data-code="{{ $content->id }}">
                                ...
                                <td class="align-middle">
                                    <div class="row">
                                        ...
                                        <form action="{{ route('admin.serv05.content.destroy', ['SERV05ServicesContent' => $content->id]) }}" class="col-4" method="POST">
                                            @method('DELETE') @csrf
