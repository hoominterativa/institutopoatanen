        ...
        <div class="card">
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-6">
                        <button id="btSubmitDelete"
                            data-route="{{ route('admin.unit01.gallery.destroySelected') }}" type="button" class="btn btn-danger btDeleteGalleries" style="display: none;">Deletar selecionados</button>
                    </div>
                    <div class="col-6">
                ...
                <table class="table table-bordered table-sortable">
                    ...
                    <tbody data-route="{{ route('admin.unit01.gallery.sorting') }}">
                            ...
                            <tr data-code="{{ $gallery->id }}">
                                ...
                                <td class="align-middle">
                                    <div class="row">
                                        ...
                                        <form action="{{ route('admin.unit01.gallery.destroy', ['UNIT01UnitsGallery' => $gallery->id]) }}" class="col-4" method="POST">
                                            @method('DELETE') @csrf
                                            ...
                                            <div class="modal-dialog" style="max-width: 900px;">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body p-3 pt-0 pb-3">
                                                        @include(
                                                            'Admin.cruds.Units.UNIT01.Galleries.form',
                                                            [
                                                                'gallery' => $gallery,
                                                            ]
                                                        )
...
<div id="modal-gallery-create" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" style="max-width: 900px;">
        <div class="modal-content">
            ...
            <div class="modal-body p-3 pt-0 pb-3">
                @include('Admin.cruds.Units.UNIT01.Galleries.form', [
                    'gallery' => null,
                ])
            </div>
        </div>
