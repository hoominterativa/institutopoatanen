        ...
        <div class="row">
            <div class="col-12 col-lg-6">
                <div class="card card-body border" id="tooltip-container">
                    ...
                    <div class="mb-3">
                        {!! Form::label('description', 'Descrição para a box', ['class'=>'form-label']) !!}
                        ...
                        <div class="container-image-crop">
                            ...
                            <label class="area-input-image-crop" for="inputImage">
                                {!! Form::file('path_image_icon', [
                                    ...
                                    'data-default-file' => isset($subcategory)
                                        ? ($subcategory->path_image_icon != ''
                                            ? url('storage/' . $subcategory->path_image_icon)
                                            : '')
                                        : '',
                                ]) !!}
                            </label>
