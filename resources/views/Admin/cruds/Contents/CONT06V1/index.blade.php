                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">{{ getTitleModel($configModelsMain, 'Contents', 'CONT06V1') }}</li>
                                </ol>
                            </div>
                            <h4 class="page-title">{{ getTitleModel($configModelsMain, 'Contents', 'CONT06V1') }}</h4>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-6">
                                        <button id="btSubmitDelete" data-route="{{route('admin.cont06v1.destroySelected')}}" type="button" class="btn btn-danger btnDeleteCONT06V1" style="display: none;">Deletar selecionados</button>
                                    </div>
                                    <div class="col-6">
                                        <a href="{{route('admin.cont06v1.create')}}" class="btn btn-success float-end">Adicionar novo <i class="mdi mdi-plus"></i></a>
                                    </div>
                                </div>
                                <table class="table table-bordered table-sortable">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th width="30px" class="bs-checkbox">
                                                <label><input name="btnSelectAll" value="btnDeleteCONT06V1" type="checkbox"></label>
                                            </th>
                                            <th>Imagem</th>
                                    ...
                                    <tbody data-route="{{route('admin.cont06v1.sorting')}}">
                                        @foreach ($contents as $content)
                                            <tr data-code="{{$content->id}}">
                                                ...
                                                <td class="align-middle">
                                                    <div class="row">
                                                        <div class="col-4">
                                                            <a href="{{route('admin.cont06v1.edit',['CONT06V1Contents' => $content->id])}}" class="btn-icon mdi mdi-square-edit-outline"></a>
                                                        </div>
                                                        <form action="{{route('admin.cont06v1.destroy',['CONT06V1Contents' => $content->id])}}" class="col-4" method="POST">
                                                            @method('DELETE') @csrf
