    ...
    <div class="col-12 col-lg-6">
        <div class="card card-body" id="tooltip-container">
            ...
            <div class="mb-3">
                ...
                {!! Form::text('color', null, ['class' => 'form-control colorpicker-default', 'id' => 'color', ]) !!}
            </div>
        </div>
        ...
        <div class="card card-body" id="tooltip-container">
            ...
            <div class="mb-3">
                <div class="container-image-crop">
                    ...
                    <small class="ms-2">Dimensões proporcionais mínimas
                        {{ $cropSetting->path_image_background_desktop->width }}x{{ $cropSetting->path_image_background_desktop->height }}px!</small>
                    <label class="area-input-image-crop" for="inputImage">
                        {!! Form::file('path_image_background_desktop', [
                            ...
                            'accept' => '.jpg,.jpeg,.png,.gif,.bmp,.tiff,.webp',
                            'data-default-file' => isset($content)
                                ? ($content->path_image_background_desktop != ''
                                    ? url('storage/' . $content->path_image_background_desktop)
                                    : '')
                                : '',
                        ]) !!}
                    </label>
            ...
            <div class="mb-3">
                <div class="container-image-crop">
                    ...
                    <small class="ms-2">Dimensões proporcionais mínimas
                        {{ $cropSetting->path_image_background_mobile->width }}x{{ $cropSetting->path_image_background_mobile->height }}px!</small>
                    <label class="area-input-image-crop" for="inputImage">
                        {!! Form::file('path_image_background_mobile', [
                            ...
                            'accept' => '.jpg,.jpeg,.png,.gif,.bmp,.tiff,.webp',
                            'data-default-file' => isset($content)
                                ? ($content->path_image_background_mobile != ''
                                    ? url('storage/' . $content->path_image_background_mobile)
                                    : '')
                                : '',
                        ]) !!}
                    </label>
