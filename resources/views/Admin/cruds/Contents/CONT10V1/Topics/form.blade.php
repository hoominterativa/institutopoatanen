@if (isset($topic))
    {!! Form::model($topic, ['route' => ['admin.cont10v1.topic.update', $topic->id], 'class'=>'parsley-validate', 'files' => true]) !!}
    @method('PUT')
@else
    {!! Form::model(null, ['route' => ['admin.cont10v1.topic.store'], 'class'=>'parsley-validate', 'files' => true]) !!}
            ...
            <div class="wrapper-links my-2 border px-2 py-3">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-4">
                        ...
                        {!! Form::select('link_target_button', ['_self' => 'Na mesma aba', '_blank' => 'Em nova aba'], null, [
                            'class' => 'form-select',
                            'id' => 'link_target_button',
                        ]) !!}
                    </div>
                </div>
