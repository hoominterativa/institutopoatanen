        ...
        <div class="content">
            ...
            <div class="container-fluid">
                ...
                <div class="tab-content">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-6">
                                                <button id="btSubmitDelete"
                                                    data-route="{{ route('admin.cont10.destroySelected') }}" type="button"
                                                    class="btn btn-danger btnDeleteContents" style="display: none;">Deletar
                                                    selecionados</button>
                                            </div>
                                            <div class="col-6">
                                                <a href="{{ route('admin.cont10.create') }}"
                                                ...
                                                @foreach ($contents as $content)
                                                    <tr data-code="{{ $content->id }}">
                                                        ...
                                                        <td class="align-middle">
                                                            <div class="row">
                                                                <div class="col-4">
                                                                    <a href="{{ route('admin.cont10.edit', ['CONT10Contents' => $content->id]) }}"
                                                                        class="btn-icon mdi mdi-square-edit-outline"></a>
                                                                </div>
                                                                <form
                                                                    action="{{ route('admin.cont10.destroy', ['CONT10Contents' => $content->id]) }}"
                    ...
                    @include('Admin.cruds.Contents.CONT10.Section.form')
                </div>
                <!-- end row -->
            </div> <!-- container -->
        </div> <!-- content -->
