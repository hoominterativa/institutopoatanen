        ...
        <div class="card">
            <div class="card-body">
                ...
                <table class="table table-bordered table-sortable">
                    ...
                    <tbody data-route="{{route('admin.cont10.topic.sorting')}}">
                            ...
                            <tr data-code="{{$topic->id}}">
                                ...
                                <td class="align-middle">
                                    <div class="row">
                                        ...
                                        <form action="{{route('admin.cont10.topic.destroy',['CONT10ContentsTopic' => $topic->id])}}" class="col-4" method="POST">
                                            @method('DELETE') @csrf
                                            ...
                                            <div class="modal-dialog" style="max-width: 900px;">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body p-3 pt-0 pb-3">
                                                        @include('Admin.cruds.Contents.CONT10.Topics.form',[
                                                            'topic' => $topic
                                                        ])
                                                    </div>
                                                </div>
