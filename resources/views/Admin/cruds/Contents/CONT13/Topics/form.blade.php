@if (isset($topic))
    {!! Form::model($topic, ['route' => ['admin.cont13.topics.update', $topic->id], 'class'=>'parsley-validate', 'files' => true]) !!}
    @method('PUT')
@else
    {!! Form::model(null, ['route' => ['admin.cont13.topics.store'], 'class'=>'parsley-validate', 'files' => true]) !!}
@endif
<div class="row">
            ...
            <div class="wrapper-links my-2 border px-2 py-3">
                ...
                <div class="row">
                    <div class="col-12 col-sm-8">
                        {!! Form::label(null, 'Link do tópico', ['class' => 'form-label']) !!}
