            ...
            <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">{{getTitleModel($configModelsMain, 'Contents', 'CONT14')}}</li>
                                </ol>
                            </div>
                            <h4 class="page-title">{{getTitleModel($configModelsMain, 'Contents', 'CONT14')}}</h4>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                ...
                <ul class="mb-0 nav nav-tabs" id="tooltip-container">
                    <li class="nav-item">
                        <a href="#contents" data-bs-toggle="tab" aria-expanded="true" class="nav-link active d-flex align-items-center">
                            {{ getTitleModel($configModelsMain, 'Contents', 'CONT14') }}
                    ...
                    <li class="nav-item">
                        <a href="#categories" data-bs-toggle="tab" aria-expanded="true" class="nav-link d-flex align-items-center">
                            ...
                            <i href="javascript:void(0)" class="mdi mdi-help-circle font-20 ms-2 btn-icon"
                                data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top"
                                data-bs-original-title="Cadastro das categorias"></i>
                        </a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content">
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row mb-3">
                                            <div class="col-6">
                                                <button id="btSubmitDelete" data-route="{{route('admin.cont14.destroySelected')}}" type="button" class="btn btn-danger btnDeleteCONT14" style="display: none;">Deletar selecionados</button>
                                            </div>
                                            <div class="col-6">
                                                <a href="{{route('admin.cont14.create')}}" class="btn btn-success float-end">Adicionar novo <i class="mdi mdi-plus"></i></a>
                                            </div>
                                        </div>
                                        <table class="table table-bordered table-sortable">
                                            <thead class="table-light">
                                                <tr>
                                                    ...
                                                    <th width="30px" class="bs-checkbox">
                                                        <label><input name="btnSelectAll" value="btnDeleteCONT14" type="checkbox"></label>
                                                    </th>
                                                    <th>Imagem</th>
                                                    <th>Categoria</th>
                                            ...
                                            <tbody data-route="{{route('admin.cont14.sorting')}}">
                                                @foreach ($contents as $content)
                                                    <tr data-code="{{$content->id}}">
                                                        ...
                                                        <td class="align-middle">
                                                            <div class="row">
                                                                <div class="col-4">
                                                                    <a href="{{route('admin.cont14.edit',['CONT14Contents' => $content->id])}}" class="btn-icon mdi mdi-square-edit-outline"></a>
                                                                </div>
                                                                <form action="{{route('admin.cont14.destroy',['CONT14Contents' => $content->id])}}" class="col-4" method="POST">
                                                                    @method('DELETE') @csrf
                    ...
                    <div class="tab-pane" id="categories">
                        @include('Admin.cruds.Contents.CONT14.Categories.index',[
                            'categories' => $categories,
                        ])
                    </div>
                    <div class="tab-pane" id="section">
                        @include('Admin.cruds.Contents.CONT14.Section.form')
                    </div>
                </div>
                <!-- end row -->
            </div> <!-- container -->
