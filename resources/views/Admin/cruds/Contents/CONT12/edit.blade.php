            ...
            <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Editar {{ getTitleModel($configModelsMain, 'Contents', 'CONT12')}}</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Editar {{ getTitleModel($configModelsMain, 'Contents', 'CONT12')}}</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="content">
                        {!! Form::model($content, ['route' => ['admin.cont12.update', $content->id], 'class'=>'parsley-validate', 'method'=>'PUT', 'files'=>true]) !!}
                    ...
                    <div class="tab-pane" id="topics">
                        @include('Admin.cruds.Contents.CONT12.Topics.index',[
                            'topics' => $topics,
                            'content' => $content
                        ])
                    </div>
