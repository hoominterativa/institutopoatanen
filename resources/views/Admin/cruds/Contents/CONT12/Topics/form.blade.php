@if (isset($topic))
    {!! Form::model($topic, ['route' => ['admin.cont12.topic.update', $topic->id], 'class'=>'parsley-validate', 'files' => true]) !!}
    @method('PUT')
@else
    {!! Form::model(null, ['route' => ['admin.cont12.topic.store'], 'class'=>'parsley-validate', 'files' => true]) !!}
        ...
        <div class="card card-body border" id="tooltip-container">
            <div class="mb-3">
                <div class="container-image-crop">
                    {!! Form::label('inputImage', 'Icone', ['class' => 'form-label']) !!}
            ...
            <div class="mb-3">
                {!! Form::label('file', 'Arquivo para download:', ['class'=>'form-label']) !!}
