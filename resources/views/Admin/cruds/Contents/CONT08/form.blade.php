...
@else
    {!! Form::model(null, ['route' => 'admin.cont08.store', 'class'=>'parsley-validate', 'files'=>true]) !!}
@endif
                    ...
                    <div class="container-image-crop">
                        ...
                        <label class="area-input-image-crop" for="inputImage">
                            {!! Form::file('path_image_desktop', [
                                ...
                                'data-box-height'=>'225', // Input height in the form
                                'accept'=>'.jpg,.jpeg,.png,.gif,.bmp,.tiff,.webp',
                                'data-default-file'=> isset($content)?($content->path_image_desktop<>''?url('storage/'.$content->path_image_desktop):''):'',
                            ]) !!}
                        </label>
                    </div><!-- END container image crop -->
                </div>
                    ...
                    <div class="container-image-crop">
                        ...
                        <label class="area-input-image-crop" for="inputImage">
                            {!! Form::file('path_image_mobile', [
                                ...
                                'data-box-height'=>'225', // Input height in the form
                                'accept'=>'.jpg,.jpeg,.png,.gif,.bmp,.tiff,.webp',
                                'data-default-file'=> isset($content)?($content->path_image_mobile<>''?url('storage/'.$content->path_image_mobile):''):'',
                            ]) !!}
                        </label>
                    </div><!-- END container image crop -->
                </div>
