@if (isset($topic))
    {!! Form::model($topic, ['route' => ['admin.cont10v2.topic.update', $topic->id], 'class'=>'parsley-validate', 'files' => true]) !!}
    @method('PUT')
@else
    {!! Form::model(null, ['route' => ['admin.cont10v2.topic.store'], 'class'=>'parsley-validate', 'files' => true]) !!}
