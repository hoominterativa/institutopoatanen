@if ($content)
    {!! Form::model($content, ['route' => ['admin.cont04.update', $content->id], 'class'=>'parsley-validate', 'method'=>'PUT', 'files'=>true]) !!}
@else
    {!! Form::model(null, ['route' => 'admin.cont04.store', 'class'=>'parsley-validate', 'files'=>true]) !!}
@endif
