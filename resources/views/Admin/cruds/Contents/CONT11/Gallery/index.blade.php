    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-6">
                        <button id="btSubmitDelete" data-route="{{route('admin.cont11.gallery.destroySelected')}}" type="button" class="btn btn-danger btnDeleteGallery" style="display: none;">Deletar selecionados</button>
                    </div>
                    <div class="col-6">
                ...
                <table class="table table-bordered table-sortable">
                    ...
                    <tbody data-route="{{route('admin.cont11.gallery.sorting')}}">
                            ...
                            <tr data-code="{{$gallery->id}}">
                                ...
                                <td class="align-middle avatar-group">
                                    @if ($gallery->path_image)
                                        <a href="{{asset('storage/' . $gallery->path_image)}}" data-fancybox="gallery">
                                            <div class="avatar-bg rounded-circle avatar-sm" style="background-image: url({{asset('storage/' . $gallery->path_image)}})"></div>
                                        </a>
                                    @endif
                                </td>
                                <td class="align-middle">
                                    <form action="{{route('admin.cont11.gallery.destroy',['CONT11ContentsGallery' => $gallery->id])}}" method="POST">
                                        @method('DELETE') @csrf
    ...
    <div class="modal-dialog" style="max-width: 1100px;">
        <div class="modal-content">
            ...
            <div class="modal-body p-3 pt-0 pb-3">
                @include('Admin.cruds.Contents.CONT11.Gallery.form')
            </div>
        </div>
    </div>
</div>
