            ...
            <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">{{ getTitleModel ($configModelsMain, 'Topics', 'TOPI10V1')}}</li>
                                </ol>
                            </div>
                            <h4 class="page-title">{{ getTitleModel ($configModelsMain, 'Topics', 'TOPI10V1')}}</h4>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                ...
                <ul class="mb-0 nav nav-tabs" id="tooltip-container">
                    <li class="nav-item">
                        <a href="#topics" data-bs-toggle="tab" aria-expanded="true" class="nav-link active d-flex align-items-center">
                            {{getTitleModel($configModelsMain, 'Topics', 'TOPI10V1')}}
                ...
                <div class="tab-content">
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row mb-3">
                                            <div class="col-6">
                                                <button id="btSubmitDelete" data-route="{{route('admin.topi10v1.destroySelected')}}" type="button" class="btn btn-danger btnDeleteTOPI10V1" style="display: none;">Deletar selecionados</button>
                                            </div>
                                            <div class="col-6">
                                                <a href="{{route('admin.topi10v1.create')}}" class="btn btn-success float-end">Adicionar novo <i class="mdi mdi-plus"></i></a>
                                            </div>
                                        </div>
                                        <table class="table table-bordered table-sortable">
                                            <thead class="table-light">
                                                <tr>
                                                    ...
                                                    <th width="30px" class="bs-checkbox">
                                                        <label><input name="btnSelectAll" value="btnDeleteTOPI10V1" type="checkbox"></label>
                                                    </th>
                                                    <th>Imagem</th>
                                                    <th>Título</th>
                                                    <th>Descrição</th>
                                            ...
                                            <tbody data-route="{{route('admin.topi10v1.sorting')}}">
                                                @foreach ($topics as $topic)
                                                    <tr data-code="{{$topic->id}}">
                                                        ...
                                                        <td class="align-middle">
                                                            <div class="row">
                                                                <div class="col-4">
                                                                    <a href="{{route('admin.topi10v1.edit',['TOPI10V1Topics' => $topic->id])}}" class="btn-icon mdi mdi-square-edit-outline"></a>
                                                                </div>
                                                                <form action="{{route('admin.topi10v1.destroy',['TOPI10V1Topics' => $topic->id])}}" class="col-4" method="POST">
                                                                    @method('DELETE') @csrf
                    ...
                    <div class="tab-pane" id="section">
                        @include("Admin.cruds.Topics.TOPI10V1.Section.form")
                    </div>
                </div>
                <!-- end row -->
            </div> <!-- container -->
