                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">
                                        {{ getTitleModel($configModelsMain, 'Topics', 'TOPI01') }}</li>
                                </ol>
                            </div>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-6">
                                        <button id="btSubmitDelete" data-route="{{ route('admin.topi01.destroySelected') }}"
                                            type="button" class="btn btn-danger btnDeleteTOPI01"
                                            style="display: none;">Deletar selecionados</button>
                                    </div>
                                    <div class="col-6">
                                        <a href="{{ route('admin.topi01.create') }}"
                                    ...
                                    <div class="col-12 mt-3">
                                        <div class="collapse bg-light p-3 mb-3" id="topicSection">
                                            @if ($section)
                                                {!! Form::model($section, [
                                                    'route' => ['admin.topi01.section.update', $section->id],
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="container-image-crop">
                                                            ...
                                                            <small class="ms-2">Dimensões proporcionais mínimas
                                                                {{ $cropSetting->Section->path_image_background->width }}x{{ $cropSetting->Section->path_image_background->height }}px!</small>
                                                            <label class="area-input-image-crop" for="inputImage">
                                                                {!! Form::file('path_image_background', [
                                                                    ...
                                                                    'data-default-file' => isset($section)
                                                                        ? ($section->path_image_background != ''
                                                                            ? url('storage/' . $section->path_image_background)
                                                                            : '')
                                                                        : '',
                                                                ]) !!}
                                                            </label>
                                    ...
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th width="30px" class="bs-checkbox">
                                                <label><input name="btnSelectAll" value="btnDeleteTOPI01"
                                                        type="checkbox"></label>
                                            </th>
                                            <th width="90px"></th>
                                            <th>Título</th>
                                        ...
                                        @foreach ($topics as $topic)
                                            <tr data-code="{{ $topic->id }}">
                                                ...
                                                <td class="align-middle">
                                                    <div class="row">
                                                        <div class="col-4">
                                                            <a href="{{ route('admin.topi01.edit', ['TOPI01Topics' => $topic->id]) }}"
                                                                class="btn-icon mdi mdi-square-edit-outline"></a>
                                                        </div>
                                                        <form
                                                            action="{{ route('admin.topi01.destroy', ['TOPI01Topics' => $topic->id]) }}"
