                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Cadastro {{getTitleModel($configModelsMain, 'Topics', 'TOPI01')}}</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Cadastro {{getTitleModel($configModelsMain, 'Topics', 'TOPI01')}}</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
