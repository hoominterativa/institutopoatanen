                ...
                <div class="row mb-3">
                    <div class="col-6">
                        <button id="btSubmitDelete"
                            data-route="{{ route('admin.topi04.topic.section.destroySelected') }}" type="button" class="btn btn-danger btDeleteTopicSections" style="display: none;">Deletar selecionados</button>
                    </div>
                    <div class="col-6">
                    ...
                    <thead class="table-light">
                        <tr>
                            ...
                            <th width="30px" class="bs-checkbox">
                                <label><input name="btnSelectAll" value="btDeleteTopicSections" type="checkbox"></label>
                            </th>
                            <th>Imagem</th>
                            <th>Título</th>
                            ...
                            <tr data-code="{{ $topicSection->id }}">
                                ...
                                <td class="align-middle">
                                    <div class="row">
                                        ...
                                        <form action="{{ route('admin.topi04.topic.section.destroy', ['TOPI04TopicsTopicSection' => $topicSection->id]) }}" class="col-4" method="POST">
                                            @method('DELETE') @csrf
