    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-6">
                        <button id="btSubmitDelete" data-route="{{route('admin.topi04.gallery.destroySelected')}}" type="button" class="btn btn-danger btnDeleteGallery" style="display: none;">Deletar selecionados</button>
                    </div>
                    <div class="col-6">
                        <a href="javascript:void(0)"  data-bs-target="#modal-gallery-create" data-bs-toggle="modal" class="btn btn-success float-end">Adicionar imagem <i class="mdi mdi-plus"></i></a>
                    </div>
                </div>
                <table class="table table-bordered table-sortable">
                    ...
                    <tbody data-route="{{route('admin.topi04.gallery.sorting')}}">
                        @foreach ($galleries as $gallery)
                            <tr data-code="{{$gallery->id}}">
                                ...
                                <td class="align-middle">
                                    <div class="row">
                                        <form action="{{route('admin.topi04.gallery.destroy',['TOPI04TopicsGallery' => $gallery->id])}}" class="col-4" method="POST">
                                            @method('DELETE') @csrf
    ...
    <div class="modal-dialog" style="max-width: 900px;">
        <div class="modal-content">
            ...
            <div class="modal-body p-3 pt-0 pb-3">
                @include('Admin.cruds.Topics.TOPI04.Gallery.form',[
                    'gallery' => null
                ])
            </div>
        </div>
