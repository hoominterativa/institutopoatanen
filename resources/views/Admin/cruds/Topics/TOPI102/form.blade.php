    ...
    <div class="row col-12">
        <div class="col-12 col-lg-6">
            <div class="card card-body" id="tooltip-container">
                ...
                <div class="mb-3">
                    {!! Form::label('title_lightbox', 'Título do ligthbox', ['class' => 'form-label']) !!}
                    {!! Form::text('title_lightbox', null, ['class' => 'form-control', 'required'=>'required', 'id' => 'title_lightbox']) !!}
                </div>
                <div class="mb-3">
                ...
                <div class="col-12">
                    <div class="normal-editor__content mb-3">
                        {!! Form::label('text', 'Texto lightbox', ['class'=>'form-label']) !!}
                ...
                <div class="wrapper-links my-2 border px-2 py-3">
                    ...
                    <div class="row">
                        <div class="mb-3">
                            ...
                            {!! Form::text('title_button', null, ['class' => 'form-control', 'required'=>'required', 'id' => 'title_button']) !!}
                        </div>
            ...
            <div class="card card-body">
                ...
                <div class="mb-3">
                    <div class="container-image-crop">
                        ...
                        <small class="ms-2">Dimensões proporcionais mínimas
                            {{ $cropSetting->path_image_lightbox->width }}x{{ $cropSetting->path_image_lightbox->height }}px!</small>
                        <label class="area-input-image-crop" for="inputImage">
                            {!! Form::file('path_image_lightbox', [
                                'id' => 'inputImage',
                                'class' => 'inputImage',
                                'data-status' => $cropSetting->path_image_lightbox->activeCrop, // px
                                'data-min-width' => $cropSetting->path_image_lightbox->width, // px
                                'data-min-height' => $cropSetting->path_image_lightbox->height, // px
                                'data-box-height' => '250', // Input height in the form
                                'accept' => '.jpg,.jpeg,.png,.gif,.bmp,.tiff,.webp',
                                'data-default-file' => isset($topic)
                                    ? ($topic->path_image_lightbox != ''
                                        ? url('storage/' . $topic->path_image_lightbox)
                                        : '')
                                    : '',
                            ]) !!}
                        </label>
