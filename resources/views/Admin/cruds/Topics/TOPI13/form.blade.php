    ...
    <div class="col-12 col-lg-6">
        <div class="card card-body" id="tooltip-container">
            ...
            <div class="mb-3">
                ...
                {!! Form::text('color', null, ['class' => 'form-control colorpicker-default','id' => 'colorpicker-default',]) !!}
            </div>
        </div>
                ...
                <div class="container-image-crop">
                    ...
                    <label class="area-input-image-crop" for="inputImage">
                        {!! Form::file('path_image_desktop', [
                            ...
                            'data-box-height'=>'180', // Input height in the form
                            'accept'=>'.jpg,.jpeg,.png,.gif,.bmp,.tiff,.webp',
                            'data-default-file'=> isset($topic)?($topic->path_image_desktop<>''?url('storage/'.$topic->path_image_desktop):''):'',
                        ]) !!}
                    </label>
                </div><!-- END container image crop -->
            </div>
                ...
                <div class="container-image-crop">
                    ...
                    <label class="area-input-image-crop" for="inputImage">
                        {!! Form::file('path_image_mobile', [
                            ...
                            'data-box-height'=>'180', // Input height in the form
                            'accept'=>'.jpg,.jpeg,.png,.gif,.bmp,.tiff,.webp',
                            'data-default-file'=> isset($topic)?($topic->path_image_mobile<>''?url('storage/'.$topic->path_image_mobile):''):'',
                        ]) !!}
                    </label>
                </div><!-- END container image crop -->
            </div>
