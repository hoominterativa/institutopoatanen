        ...
        <div class="card">
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-6">
                        <button id="btSubmitDelete"
                            data-route="{{ route('admin.port02.gallery.destroySelected') }}" type="button"
                ...
                <table class="table table-bordered table-sortable">
                    ...
                    <tbody data-route="{{ route('admin.port02.gallery.sorting') }}">
                            ...
                            <tr data-code="{{ $gallery->id }}">
                                ...
                                <td class="align-middle">
                                    <div class="row">
                                        ...
                                        <form
                                            action="{{ route('admin.port02.gallery.destroy', ['PORT02PortfoliosGallery' => $gallery->id]) }}"
                                            ...
                                            <div class="modal-dialog" style="max-width: 1100px;">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body p-3 pt-0 pb-3">
                                                        @include(
                                                            'Admin.cruds.Portfolios.PORT02.Galleries.form',
                                                            [
                                                                'gallery' => $gallery,
                                                            ]
                                                        )
...
<div id="modal-gallery-create" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog" style="max-width: 1100px;">
        <div class="modal-content">
            ...
            <div class="modal-body p-3 pt-0 pb-3">
                @include('Admin.cruds.Portfolios.PORT02.Galleries.form', [
                    'gallery' => null,
                ])
            </div>
        </div>
