@if (isset($gallery))
    {!! Form::model($gallery, ['route' => ['admin.port05.gallery.update', $gallery->id], 'class'=>'parsley-validate', 'files' => true]) !!}
    @method('PUT')
@else
    {!! Form::model(null, ['route' => ['admin.port05.gallery.store'], 'class'=>'parsley-validate', 'files' => true]) !!}
    {!! Form::hidden('portfolio_id', $portfolio->id) !!}
@endif
<div class="row">
    <div class="col-12">
        <div class="alert alert-warning mb-3">
            <p class="mb-0">Caso seja cadastrado um link para o vídeo, a imagem sera usada automáticamente como capa do vídeo.</p>
        </div>
    </div>
