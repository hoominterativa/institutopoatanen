    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-6">
                        <button id="btSubmitDelete" data-route="{{route('admin.port05.gallery.destroySelected')}}" type="button" class="btn btn-danger btnDeleteGallery" style="display: none;">Deletar selecionados</button>
                    </div>
                    <div class="col-6">
                            ...
                            <tr data-code="{{$gallery->id}}">
                                ...
                                <td class="align-middle">
                                    <div class="row">
                                        ...
                                        <form action="{{route('admin.port05.gallery.destroy',['PORT05PortfoliosGallery' => $gallery->id])}}" class="col-4" method="POST">
                                            @method('DELETE') @csrf
