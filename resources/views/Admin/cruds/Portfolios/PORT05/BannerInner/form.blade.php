@if ($portfolio)
    {!! Form::model($portfolio, ['route' => ['admin.port05.update', $portfolio->id],'class' => 'parsley-validate','files' => true,]) !!}
    @method('PUT')
    {!! Form::hidden('active', $portfolio->active) !!}
    {!! Form::hidden('featured', $portfolio->featured) !!}
    {!! Form::hidden('slug', $portfolio->slug) !!}
@else
                    ...
                    <label class="area-input-image-crop" for="inputImage">
                        {!! Form::file('path_image_desktop_banner', [
                            ...
                            'data-default-file' => isset($portfolio)
                                ? ($portfolio->path_image_desktop_banner != ''
                                    ? url('storage/' . $portfolio->path_image_desktop_banner)
                                    : '')
                                : '',
                        ]) !!}
                    </label>
                ...
                <div class="container-image-crop">
                    ...
                    <label class="area-input-image-crop" for="inputImage">
                        {!! Form::file('path_image_mobile_banner', [
                            ...
                            'accept' => '.jpg,.jpeg,.png,.gif,.bmp,.tiff,.webp',
                            'data-default-file' => isset($portfolio)
                                ? ($portfolio->path_image_mobile_banner != ''
                                    ? url('storage/' . $portfolio->path_image_mobile_banner)
                                    : '')
                                : '',
                        ]) !!}
                    </label>
