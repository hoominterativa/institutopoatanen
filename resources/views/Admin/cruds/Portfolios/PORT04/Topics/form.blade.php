@if (isset($topic))
    {!! Form::model($topic, ['route' => ['admin.port04.topics.update', $topic->id], 'class'=>'parsley-validate', 'files' => true]) !!}
    @method('PUT')
@else
    {!! Form::model(null, ['route' => ['admin.port04.topics.store'], 'class'=>'parsley-validate', 'files' => true]) !!}
