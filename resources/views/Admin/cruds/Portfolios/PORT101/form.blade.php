...
<div class="row col-12">
    <div class="col-12 col-lg-6">
        <div class="card card-body" id="tooltip-container">
            ...
            <div class="row">
                <h4 class="mb-3 mt-0">Caso você queira cadastrar algum link para uma página externa <small>(Opcional)</small></h4>
                ...
                <div class="container-image-crop">
                    ...
                    <label class="area-input-image-crop" for="inputImage">
                        {!! Form::file('path_image_desktop', [
                            ...
                            'data-box-height'=>'180', // Input height in the form
                            'accept'=>'.jpg,.jpeg,.png,.gif,.bmp,.tiff,.webp',
                            'data-default-file'=> isset($portfolio)?$portfolio->path_image_desktop<>''?url('storage/'.$portfolio->path_image_desktop):'':'',
                        ]) !!}
                    </label>
                </div><!-- END container image crop -->
            </div>
                ...
                <div class="container-image-crop">
                    ...
                    <label class="area-input-image-crop" for="inputImage">
                        {!! Form::file('path_image_mobile', [
                            ...
                            'data-box-height'=>'180', // Input height in the form
                            'accept'=>'.jpg,.jpeg,.png,.gif,.bmp,.tiff,.webp',
                            'data-default-file'=> isset($portfolio)?$portfolio->path_image_mobile<>''?url('storage/'.$portfolio->path_image_mobile):'':'',
                        ]) !!}
                    </label>
                </div><!-- END container image crop -->
            </div>
