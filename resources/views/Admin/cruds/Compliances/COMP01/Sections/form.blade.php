@if (isset($section))
    ...
    {!! Form::model($section, ['route' => ['admin.comp01.section.update', $section->id], 'class'=>'parsley-validate', 'files' => true]) !!}
    @method('PUT')
@else
    {!! Form::model(null, ['route' => ['admin.comp01.section.store'], 'class'=>'parsley-validate', 'files' => true]) !!}
@endif
