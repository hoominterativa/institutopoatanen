        ...
        <div class="wrapper-links my-2 border px-2 py-3">
            ...
            <div class="row">
                <div class="col-12 col-sm-8">
                    ...
                    {!! Form::url('link', (isset($additionalLink) ? getUri($additionalLink->link) : null), ['class'=>'form-control', 'parsley-type'=>'url', 'required'=>true, 'id' => 'targetUrl'.(isset($additionalLink)?'-'.$additionalLink->id:'')]) !!}
                </div>
