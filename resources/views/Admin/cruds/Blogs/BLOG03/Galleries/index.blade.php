    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-6">
                        <button id="btSubmitDelete" data-route="{{ route('admin.blog03.images.destroySelected') }}"
                            type="button" class="btn btn-danger btDeleteGalleries" style="display: none;">Deletar
                            selecionados</button>
                    </div>
                    <div class="col-6">
                        ...
                        @foreach ($galleries as $gallery)
                            <tr data-code="{{ $gallery->id }}">
                                ...
                                <td class="align-middle">
                                    @if ($gallery->link_url)
                                        <a href="{{ $gallery->link_url }}" target="_blank">{{ $gallery->link_url }}</a>
                                    @else
                                ...
                                <td class="align-middle">
                                    <div class="row">
                                        ...
                                        <form
                                            action="{{ route('admin.blog03.images.destroy', ['BLOG03BlogsGalleries' => $gallery->id]) }}"
                                            ...
                                            <div class="modal-dialog" style="max-width: 900px;">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body p-3 pt-0 pb-3">
                                                        @include(
                                                            'Admin.cruds.Blogs.BLOG03.Galleries.form',
                                                            [
                                                                'gallery' => $gallery,
                                                            ]
                                                        )
...
<div id="modal-gallery-create" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog" style="max-width: 900px;">
        <div class="modal-content">
            ...
            <div class="modal-body p-3 pt-0 pb-3">
                @include('Admin.cruds.Blogs.BLOG03.Galleries.form', [
                    'gallery' => null,
                ])
            </div>
        </div>
