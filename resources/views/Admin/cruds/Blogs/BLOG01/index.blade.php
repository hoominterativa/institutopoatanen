                                        ...
                                        @foreach ($teste as $test)
                                            <tr data-code="{{$test->id}}">
                                                ...
                                                <td class="align-middle">
                                                    <div class="row">
                                                        <div class="col-4">
                                                            <a href="{{route('admin.blog01.edit',['code' => $test->id])}}" class="btn-icon mdi mdi-square-edit-outline"></a>
                                                        </div>
                                                        <form action="{{route('admin.blog01.destroy',['code' => $test->id])}}" class="col-4" method="POST">
                                                            @method('DELETE') @csrf
