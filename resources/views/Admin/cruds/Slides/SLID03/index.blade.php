        ...
        <div class="content">
            ...
            <div class="container-fluid">
                ...
                <ul class="mb-0 nav nav-tabs" id="tooltip-container">
                    ...
                    <li class="nav-item">
                        <a href="#formInputs" data-bs-toggle="tab" aria-expanded="true" class="nav-link d-flex align-items-center" >
                            Campos do Formulário
                            <i href="javascript:void(0)" class="mdi mdi-help-circle font-20 ms-2 btn-icon"
                                data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top"
                                data-bs-original-title="Cadastre os campos que o seu formulário receberá."></i>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="#formAdditional" data-bs-toggle="tab" aria-expanded="true" class="nav-link d-flex align-items-center" >
                            Campos Adicionais
                            <i href="javascript:void(0)" class="mdi mdi-help-circle font-20 ms-2 btn-icon"
                                data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top"
                                data-bs-original-title="Cadastre os campos adicionais que o seu formulário exibirá."></i>
                        </a>
                    </li>
                </ul>
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="form">
                        @include('Admin.cruds.Slides.SLID03.Form.form')
                    </div>
                    <div class="tab-pane" id="formInputs">
                        @include('Admin.cruds.Slides.SLID03.Form.formInputs')
                    </div>
                    <div class="tab-pane" id="formAdditional">
                        @include('Admin.cruds.Slides.SLID03.Form.formAdditional')
                    </div>
                </div>
            </div> <!-- container -->
        </div> <!-- content -->
