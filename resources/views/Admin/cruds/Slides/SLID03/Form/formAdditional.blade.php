@if ($slide)
    {!! Form::model($slide, ['route' => ['admin.slid03.additionalUpdate', $slide->id], 'class'=>'parsley-validate', 'method'=>'PUT', 'files'=>true]) !!}
@else
    {!! Form::model(null, ['route' => 'admin.slid03.additionalStore', 'class'=>'parsley-validate', 'files'=>true]) !!}
@endif
            ...
            <div class="card card-body" id="tooltip-container">
                <div class="mb-3 d-flex align-items-center">
                    <div>
                        ...
                        <p>Os campos adicionados nessa área será exibido como opção no formulário para a mecânica de duplicação no formulário, cuidado com a quantidade de campos.</p>
                ...
                <div class="row container-inputs-contact">
                    @if (isset($inputsAdditionals))
                        @foreach ($inputsAdditionals as $key => $value)
