        ...
        <div class="card card-body" id="tooltip-container">
                ...
                <div class="container-image-crop">
                    ...
                    <label class="area-input-image-crop" for="inputImage">
                        {!! Form::file('path_image_desktop_banner', [
                            ...
                            'data-default-file' => isset($section)? ($section->path_image_desktop_banner != ''? url('storage/' . $section->path_image_desktop_banner): ''): '',
                        ]) !!}
                    </label>
            ...
            <div class="mb-3">
                <div class="container-image-crop">
                    ...
                    <small class="ms-2">Dimensões proporcionais mínimas {{ $cropSetting->Section->path_image_mobile_banner->width }}x{{ $cropSetting->Section->path_image_mobile_banner->height }}px!</small>
                    <label class="area-input-image-crop" for="inputImage">
                        {!! Form::file('path_image_mobile_banner', [
                            ...
                            'data-default-file' => isset($section)? ($section->path_image_mobile_banner != ''? url('storage/' . $section->path_image_mobile_banner): ''): '',
                        ]) !!}
                    </label>
                </div><!-- END container image crop -->
            </div>
