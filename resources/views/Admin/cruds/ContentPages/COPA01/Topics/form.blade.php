@if (isset($topic))
    {!! Form::model($topic, ['route' => ['admin.copa01.topic.update', $topic->id], 'class'=>'parsley-validate', 'files' => true]) !!}
    @method('PUT')
@else
    {!! Form::model(null, ['route' => ['admin.copa01.topic.store'], 'class'=>'parsley-validate', 'files' => true]) !!}
@endif
    <div class="row">
        ...
        <div class="col-12 col-lg-6">
            <div class="card card-body border" id="tooltip-container">
                ...
                <div class="mb-3">
                    <div class="container-image-crop">
                        {!! Form::label('inputImage', 'Imagem background do box', ['class' => 'form-label']) !!}
