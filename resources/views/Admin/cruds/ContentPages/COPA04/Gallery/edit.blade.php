        ...
        <div class="content">
            ...
            <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Editar Seção Galeria</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Editar Seção Galeria</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                ...
                <ul class="mb-0 nav nav-tabs" id="tooltip-container">
                    ...
                    <li class="nav-item">
                        <a href="#galleryTopic" data-bs-toggle="tab" aria-expanded="true"
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="gallery">
                        {!! Form::model($COPA04ContentPagesGallery, ['route' => ['admin.copa04.gallery.update', $COPA04ContentPagesGallery->id], 'class'=>'parsley-validate', 'method'=>'PUT', 'files'=>true]) !!}
                            @include('Admin.cruds.ContentPages.COPA04.Gallery.form')
                    ...
                    <div class="tab-pane" id="galleryTopic">
