@if ($additionalContent)
    {!! Form::model($additionalContent, ['route' => ['admin.copa04.additionalContent.update', $additionalContent->id], 'class' => 'parsley-validate', 'files' => true,]) !!}
    @method('PUT')
@else
    {!! Form::model(null, ['route' => 'admin.copa04.additionalContent.store', 'class' => 'parsley-validate', 'files' => true]) !!}
            ...
            <div class="row">
                ...
                <div class="wrapper-links my-2 border px-2 py-3">
                    <ul class="nav nav-pills navtab-bg nav-justified">
                        <li class="nav-item">
                            <a href="#linkPages4" data-bs-toggle="tab" aria-expanded="false" class="nav-link py-1">
                        ...
                        <li class="nav-item">
                            <a href="#linkExternal4" data-bs-toggle="tab" aria-expanded="true" class="nav-link active">
                                <div class="d-flex align-items-center justify-content-center">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane" id="linkPages4">
                            <div class="row">
                        ...
                        <div class="tab-pane show active" id="linkExternal4"></div>
                    </div> {{-- END .tab-content --}}
                    <div class="row">
                        <div class="col-12">
