        ...
        <div class="content">
            ...
            <div class="container-fluid">
                ...
                <ul class="mb-0 nav nav-tabs" id="tooltip-container">
                    ...
                    <li class="nav-item">
                        <a href="#addicionalContentGallery" data-bs-toggle="tab" aria-expanded="true"
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="addicionalContent">
                        {!! Form::model($AdditionalContent, ['route' => ['admin.copa04.additionalContent.update', $AdditionalContent->id], 'class'=>'parsley-validate', 'method'=>'PUT', 'files'=>true]) !!}
                            @include('Admin.cruds.ContentPages.COPA04.AdditionalContent.form')
                    ...
                    <div class="tab-pane" id="addicionalContentGallery">
