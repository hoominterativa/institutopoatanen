            ...
            <div class="row">
                ...
                <div class="wrapper-links my-2 border px-2 py-3">
                    <ul class="nav nav-pills navtab-bg nav-justified">
                        <li class="nav-item">
                            <a href="#linkPages7" data-bs-toggle="tab" aria-expanded="false" class="nav-link py-1">
                        ...
                        <li class="nav-item">
                            <a href="#linkExternal7" data-bs-toggle="tab" aria-expanded="true" class="nav-link active">
                                <div class="d-flex align-items-center justify-content-center">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane show active" id="linkExternal7"></div>
                    </div> {{-- END .tab-content --}}
                    <div class="row">
                        <div class="col-12">
