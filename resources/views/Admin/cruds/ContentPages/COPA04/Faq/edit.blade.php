                    ...
                    <li class="nav-item">
                        <a href="#faq" data-bs-toggle="tab" aria-expanded="true"
                            ...
                            <i href="javascript:void(0)" class="mdi mdi-help-circle font-20 ms-2 btn-icon"
                                ...
                                data-bs-original-title="Cadastro faq"></i>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="#topics" data-bs-toggle="tab" aria-expanded="true"
                            ...
                            <i href="javascript:void(0)" class="mdi mdi-help-circle font-20 ms-2 btn-icon"
                                data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top"
                                data-bs-original-title="Cadastro tópicos faq"></i>
                        </a>
                    </li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane show active" id="faq">
                        {!! Form::model($COPA04ContentPagesFaq, ['route' => ['admin.copa04.faq.update', $COPA04ContentPagesFaq->id], 'class'=>'parsley-validate', 'method'=>'PUT', 'files'=>true]) !!}
                            @include('Admin.cruds.ContentPages.COPA04.Faq.form')
