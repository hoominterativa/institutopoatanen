                    ...
                    @if ($faq)
                        <tbody>
                            <tr>
                                ...
                                <td class="align-middle">{{$faq->subtitle}}</td>
                                ...
                                <td class="align-middle">
                                    <div class="row">
                                        <div class="col-4">
                                            <a href="{{route('admin.copa04.faq.edit',['COPA04ContentPagesFaq' => $faq->id])}}" class="btn-icon mdi mdi-square-edit-outline"></a>
                                        </div>
                                        <form action="{{route('admin.copa04.faq.destroy',['COPA04ContentPagesFaq' => $faq->id])}}" class="col-4" method="POST">
                                            @method('DELETE') @csrf
