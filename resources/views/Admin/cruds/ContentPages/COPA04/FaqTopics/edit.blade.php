            ...
            <div class="container-fluid">
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="faq">
                        {!! Form::model($COPA04ContentPagesFaqTopics, ['route' => ['admin.copa04.faqTopics.update', $COPA04ContentPagesFaqTopics->id], 'class'=>'parsley-validate', 'method'=>'PUT', 'files'=>true]) !!}
