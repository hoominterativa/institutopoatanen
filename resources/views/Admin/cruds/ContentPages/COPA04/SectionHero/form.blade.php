                    ...
                    <div class="wrapper-links my-2 border px-2 py-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-4">
                                {!! Form::label('target_link_two', 'Redirecionar para', ['class'=>'form-label']) !!}
                                {!! Form::select('target_link_two', ['_self' => 'Na mesma aba', '_blank' => 'Em nova aba'], null, ['class'=>'form-select', 'id'=>'target_link_two']) !!}
                            </div>
                        </div>
