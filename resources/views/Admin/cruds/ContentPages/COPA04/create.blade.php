    ...
    <div class="content-page">
        <div class="content">
            ...
            <div class="container-fluid">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item"><a
                                            href="{{ route('admin.copa04.index') }}">{{ getTitleModel($configModelsMain, 'ContentPages', 'COPA04') }}</a>
                                    </li>
                                    <li class="breadcrumb-item active">Cadastro
                                        {{ getTitleModel($configModelsMain, 'ContentPages', 'COPA04') }}</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Cadastro {{ getTitleModel($configModelsMain, 'ContentPages', 'COPA04') }}
                            </h4>
                        </div>
                    </div>
                </div>
                ...
                <a href="{{ route('admin.copa04.index') }}"
