    ...
    <div class="content-page">
        <div class="content">
            ...
            <div class="container-fluid">
                ...
                {!! Form::model($AdditionalContentImages, ['route' => ['admin.copa04.additionalContentImages.update', $AdditionalContentImages->id], 'class'=>'parsley-validate', 'method'=>'PUT', 'files'=>true]) !!}
