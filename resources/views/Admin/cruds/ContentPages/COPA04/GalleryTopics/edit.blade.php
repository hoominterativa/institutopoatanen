    ...
    <div class="content-page">
        <div class="content">
            ...
            <div class="container-fluid">
                ...
                {!! Form::model($COPA04ContentPagesGallerytopics, ['route' => ['admin.copa04.galleryTopic.update', $COPA04ContentPagesGallerytopics->id], 'class'=>'parsley-validate', 'method'=>'PUT', 'files'=>true]) !!}
