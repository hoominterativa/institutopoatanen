    ...
    <div class="content-page">
        <div class="content">
            ...
            <div class="container-fluid">
                ...
                <!-- end page title -->
                {!! Form::model($COPA04SectionHighlighted, ['route' => ['admin.copa04.sectionHighlighted.update', $COPA04SectionHighlighted->id], 'class'=>'parsley-validate', 'method'=>'PUT', 'files'=>true]) !!}
                    @include('Admin.cruds.ContentPages.COPA04.SectionHighlighted.form')
