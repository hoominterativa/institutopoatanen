            ...
            <div class="card-body">
                ...
                <table class="table table-bordered table-sortable">
                    <thead class="table-light">
                        ...
                        <tbody data-route="{{route('admin.copa04.product.sorting')}}">
                            @foreach($sectionProductItems as $sectionProductItem)
                                <tr data-code="{{$sectionProductItem->id}}">
                                    <td class="align-middle"><span class="btnDrag mdi mdi-drag-horizontal font-22"></span></td>
                                    <td class="bs-checkbox align-middle">
                                        <label><input name="btnSelectItem" class="btnSelectItem" type="checkbox" value="{{$sectionProductItem->id}}"></label>
                                    </td>
                                    <td class="align-middle">{{$sectionProductItem->title}}</td>
                                    <td class="align-middle">{{$sectionProductItem->subtitle}}</td>
                                    <td class="align-middle">
                                        @switch($sectionProductItem->active)
                                            @case(1)
