            ...
            <div class="row">
                ...
                <div class="wrapper-links my-2 border px-2 py-3">
                    <ul class="nav nav-pills navtab-bg nav-justified">
                        <li class="nav-item">
                            <a href="#linkPages5TA1" data-bs-toggle="tab" aria-expanded="false" class="nav-link py-1">
                        ...
                        <li class="nav-item">
                            <a href="#linkExternal5TA1" data-bs-toggle="tab" aria-expanded="true" class="nav-link active">
                                <div class="d-flex align-items-center justify-content-center">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane" id="linkPages5TA1">
                            <div class="row">
                                    ...
                                    <ul class="dropdown-menu multi-level col-12" aria-labelledby="dropdownPages">
                                        @foreach (listPage() as $page)
                                            <li class="dropdown {{$page->dropdown?'dropdown-submenu':''}}">
                                                <a href="{{$page->route}}" class="dropdown-item" data-bs-toggle="setUrl" data-target-url="#targetUrl1TA1" data-bs-toggle="dropdown">{{$page->title}}</a>
                                                @if ($page->dropdown)
                                                    <ul class="dropdown-menu">
                                                        @foreach ($page->dropdown as $itens)
                                                            <li><a href="{{$itens->route}}" class="dropdown-item" data-bs-toggle="setUrl" data-target-url="#targetUrl1TA1">{{$itens->name}}</a></li>
                                                        @endforeach
                                                    </ul>
                                                @endif
                                            </li>
                        ...
                        <div class="tab-pane show active" id="linkExternal5TA1"></div>
                    </div> {{-- END .tab-content --}}
                    <div class="row">
                        <div class="col-12">
                        ...
                        <div class="col-12 col-sm-8">
                            ...
                            {!! Form::url('button_link', null, ['class'=>'form-control','parsley-type'=>'url', 'id' => 'targetUrl1TA1']) !!}
                        </div>
