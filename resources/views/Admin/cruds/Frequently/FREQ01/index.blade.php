                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">
                                        {{ getTitleModel($configModelsMain, 'Frequently', 'FREQ01') }}</li>
                                </ol>
                            </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-6">
                                                <button id="btSubmitDelete"
                                                    data-route="{{ route('admin.freq01.destroySelected') }}" type="button"
                                                    class="btn btn-danger btnDeleteFREQ01" style="display: none;">Deletar
                                                    selecionados</button>
                                            </div>
                                            <div class="col-6">
                                                <a href="{{ route('admin.freq01.create') }}"
                                            ...
                                            <thead class="table-light">
                                                <tr>
                                                    ...
                                                    <th width="30px" class="bs-checkbox">
                                                        <label><input name="btnSelectAll" value="btnDeleteFREQ01"
                                                                type="checkbox"></label>
                                                    </th>
                                                    <th>Perguntas</th>
                                                    <th>Respostas</th>
                                                    ...
                                                    <tr data-code="{{ $frequently->id }}">
                                                        ...
                                                        <td class="bs-checkbox align-middle">
                                                            <label><input name="btnSelectItem" class="btnSelectItem"
                                                                    type="checkbox" value="{{ $frequently->id }}"></label>
                                                        </td>
                                                        <td class="align-middle">{{ $frequently->question }}</td>
                                                        <td class="align-middle">{!! substr($frequently->answer, 0, 50) !!}</td>
                                                        ...
                                                        <td class="align-middle">
                                                            <div class="row">
                                                                <div class="col-4">
                                                                    <a href="{{ route('admin.freq01.edit', ['FREQ01Frequently' => $frequently->id]) }}"
                                                                        class="btn-icon mdi mdi-square-edit-outline"></a>
                                                                </div>
                                                                <form
                                                                    action="{{ route('admin.freq01.destroy', ['FREQ01Frequently' => $frequently->id]) }}"
