@switch($type)
            ...
            @php
                ...
                foreach (explode(',', $options) as $option) {
                    ...
                    if (count($emails) > 1) {
                        ...
                        $selectOptions = array_merge($selectOptions, [
                            trim($emails[0] . '|' . $email) => trim($emails[0]),
                        ]);
                    }
                }
            @endphp
                ...
                @foreach (explode(',', $options) as $key => $option)
                    @if ($option)
                        <div class="col-12 col-lg-6 mb-3 form-check d-flex align-items-center">
                            {!! Form::checkbox($name . '[]', trim($option), null, [
    ...
    @case('radio')
        <div class="input__item input__item--radio">
            ...
            <div class="d-flex align-items-center input__item--radio__list">
                @foreach (explode(',', $options) as $key => $option)
