@switch($model)
    ...
    <section class="form01 container-fluid px-0" style="background-image: url({{asset('storage/uploads/tmp/bg-slide.jpg')}})">
        <div class="container container--pd">
            <div class="row mx-0">
                <div class="form01__content col-lg-6 px-0">
                    <h4 class="form01__content__title">{{$content->title->value}}</h4>
                    <div class="form01__content__paragraph">
                        <p>
                ...
                <div class="form01__content col-lg-6 px-0">
                    {!! Form::open(['route' => 'lead.store', 'method' => 'post', 'files' => true, 'class'=>'send_form_ajax form01__content__form form-contact parsley-validate d-flex row mx-0']) !!}
                        ...
                        @endforeach
                        <label for="" class="form01-form__form__checkbox-label">
                        ...
                        <button type="submit" class="form01__content__cta">
            ...
            <div class="lifo__boxRight col-lg-8 px-0 d-flex justify-content-between align-items-center">
                <div class="lifo__boxRight__image">
                    <img src="{{asset('storage/'.$content->path_image->value)}}" width="300" alt="">
                </div>
            </div>
        </div>
    </section>
