@switch($model)
    ...
    @case('FORM02')
        <section class="form02 container-fluid px-0"
                ...
                <div class="row mx-0">
                    <div class="form02__content col-lg-8 px-0 d-flex justify-content-between align-items-center">
                        ...
                        {!! Form::open([
                            ...
                            'method' => 'post',
                            'files' => true,
                            'class' => 'send_form_ajax form02__content__form form-contact parsley-validate align-items-center',
                        ]) !!}
                        ...
                        <a href="#lightbox-form" data-fancybox="fomulario-de-inscricao"
                            class="form02__content__cta data-fancybox">
                        ...
                        <div id="lightbox-form" class="lifo" style="display: none;">
                            <div class="lifo__boxLeft col-lg-4 px-0">
                                ...
                                {!! Form::open([
                                    ...
                                    'method' => 'post',
                                    'files' => true,
                                    'class' => 'send_form_ajax lifo__boxLeft__form form-contact parsley-validate align-items-center',
                                ]) !!}
                            ...
                            <div class="lifo__boxRight col-lg-8 px-0 d-flex justify-content-between align-items-center">
                                <div class="lifo__boxRight__image">
                                    <img src="{{ asset('storage/' . $content->path_image_inner->value) }}" width="300"
                                        alt="">
                                </div>
                            </div>
                        </div>
    ...
    @case('FORM03')
        <section class="form03 container-fluid px-0"
            style="background-image: url({{ asset('storage/' . $content->path_image_inner->value) }})">
            <div class="container container--pd">
                <div class="row mx-0 justify-content-between">
                    ...
                    <div class="form03__boxRight d-flex flex-column">
                        ...
                        {!! Form::open([
                            ...
                            'method' => 'post',
                            'files' => true,
                            'class' => 'send_form_ajax form03__boxRight__form form-contact parsley-validate align-items-center',
                        ]) !!}
    ...
    @case('FORM101')
        <section class="form101 container-fluid px-0"
            style="background-image: url({{ asset('storage/uploads/tmp/bg-slide.jpg') }})">
            <div class="container container--pd">
                <div class="row mx-0">
                    ...
                    <div class="form101__content col-lg-6 px-0">
                        {!! Form::open([
                            ...
                            'method' => 'post',
                            'files' => true,
                            'class' => 'send_form_ajax form101__content__form form-contact parsley-validate d-flex row mx-0',
                        ]) !!}
                        <input type="hidden" name="target_lead" value="Newslatter">
                        <input type="hidden" name="target_send" value="{{ base64_encode($contactForm->email) }}">
                        @foreach ($inputs as $name => $input)
    ...
    @case('FORM102')
        <section class="form102 container-fluid px-0"
            style="background-image: url({{ asset('storage/uploads/tmp/bg-slide.jpg') }})">
            <div class="container container--pd">
                <div class="row mx-0">
                    ...
                    <div class="form102__content col-lg-8 px-0 d-flex justify-content-between align-items-center">
                        {!! Form::open([
                            ...
                            'method' => 'post',
                            'files' => true,
                            'class' => 'send_form_ajax form102__content__form form-contact parsley-validate align-items-center',
                        ]) !!}
