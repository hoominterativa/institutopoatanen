    ...
    <main id="root">
        <div id="COMP01" class="comp01-page">
            <section class="container-fluid px-0">
                <header class="comp01-page__header"
                style="background-image: url({{asset('storage/'.$compliance->path_image_desktop_banner)}} background-color: {{$compliance->background_color_banner}})">
