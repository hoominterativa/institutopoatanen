<section id="CONT10" class="cont10 container-fluid px-0" style="background-image: url({{asset('storage/uploads/tmp/bg-section-gray.jpg')}})">
    <div class="container container--pd">
        <header class="cont10__encompass text-center
        ">
            <h4 class="cont10__encompass__title">Título Tópico</h4>
            <h5 class="cont10__encompass__subtitle">Subtitulo</h5>
        </header>
