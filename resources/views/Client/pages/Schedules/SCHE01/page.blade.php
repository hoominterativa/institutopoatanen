                                ...
                                <article class="sche01-page__cont__item d-flex flex-column">
                                            ...
                                            <ul class="sche01-page__cont__item__header__topics">
                                                <li class="sche01-page__cont__item__header__topics__item">
                                                    @if ($schedule->path_image_hours || $schedule->event_time)
                                                        <img src="{{ asset('storage/' . $schedule->path_image_hours) }}" alt="" class="sche01-page__cont__item__header__topics__item__icon">
                                                        {{ date('H:i', strtotime($schedule->event_time)) }}
                                                    @endif
                                                </li>
                                                <li class="sche01-page__cont__item__header__topics__item">
                                                    @if ($schedule->path_image_sub || $schedule->subtitle)
                                                        <img src="{{ asset('storage/' . $schedule->path_image_sub) }}" alt="" class="sche01-page__cont__item__header__topics__item__icon">
                                                        {{$schedule->subtitle}}
                                                    @endif
                                                </li>
                                            </ul>
                                    ...
                                    <main class="sche01-page__cont__item__main d-flex flex-column">
                                        @if ($schedule->path_image)
                                            <img src="{{ asset('storage/' . $schedule->path_image) }}" alt="" class="sche01-page__cont__item__img">
                                        @endif
                                        ...
                                        <a href="{{ route('sche01.show.content', ['SCHE01Schedules' => $schedule->slug]) }}" class="sche01-page__cont__item__cta">
