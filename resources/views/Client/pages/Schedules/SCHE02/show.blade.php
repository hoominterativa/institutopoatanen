        ...
        <div class="container">
            ...
            <div class="lish__content">
                ...
                <div class="lish__content__box">
                    <button class="lish__content__box__top accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#lish-1" aria-expanded="false" aria-controls="collapseTwo">
                ...
                <div class="lish__content__box">
                    <button class="lish__content__box__top accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#lish-2" aria-expanded="false" aria-controls="collapseTwo">
                        <div class="lish__content__box__top__left">
                            <h4 class="lish__content__box__top__left__title">Sexta</h4>
                            <h5 class="lish__content__box__top__left__subtitle">Salvador-BA</h5>
                        </div>
                    </button>
                    <div id="lish-2" class="lish__content__box__bottom accordion-collapse collapse" data-bs-parent="#lish-2">
                        <div class="lish__content__box__bottom__paragraph">
                            <p>
                                Lorem ipsum dolor sit amet. Aut quasi rerum et nulla voluptatem et accusamus nihil et magnam 
                                tempore quo dolore quis ea voluptatum odit. Qui vero rerum ab consequatur nobis est temporibus 
                ...
                {{-- fim-lish__content__box --}}
                <div class="lish__content__box">
                    <button class="lish__content__box__top accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#lish-3" aria-expanded="false" aria-controls="collapseTwo">
                        <div class="lish__content__box__top__left">
                            <h4 class="lish__content__box__top__left__title">Sexta</h4>
                            <h5 class="lish__content__box__top__left__subtitle">Salvador-BA</h5>
                        </div>
                    </button>
                    <div id="lish-3" class="lish__content__box__bottom accordion-collapse collapse" data-bs-parent="#lish-3">
                        <div class="lish__content__box__bottom__paragraph">
                            <p>
                                Lorem ipsum dolor sit amet. Aut quasi rerum et nulla voluptatem et accusamus nihil et magnam 
                                tempore quo dolore quis ea voluptatum odit. Qui vero rerum ab consequatur nobis est temporibus 
