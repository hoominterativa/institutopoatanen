                ...
                @foreach ($topics as $topic)
                    ...
                    <div class="topi13__item"
                        ...
                        @if ($topic->path_image_icon)
                            <img class="topi13__item__image" src="{{ asset('storage/' . $topic->path_image_icon) }}"
                                alt="Ícone do tópico">
                        @endif

                        <div class="topi13__item__information">
                            @if ($topic->text)
                                <div class="topi13__item__information__paragraph">
                                    {!! $topic->text !!}
                                </div>
                            @endif

                            @if ($topic->link_button)
                                <a class="topi13__item__information__cta" href="{{ getUri($topic->link_button) }}"
