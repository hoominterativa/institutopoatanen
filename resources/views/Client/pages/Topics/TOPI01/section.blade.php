    ...
    <section id="TOPI01" class="topi01">
        ...
        @if ($topics->count())
            <main class="topi01__topics">
                <div class="topi01__topics__carousel">
                    <div class="topi01__topics__carousel__swiper-wrapper swiper-wrapper">
                        @foreach ($topics as $topic)
                            <article class="topi01__topics__item swiper-slide">
                                @if ($topic->link)
                                    <a
                                    title="{{ $topic->title }}" class="link-full" href="{{ getUri($topic->link) }}"
