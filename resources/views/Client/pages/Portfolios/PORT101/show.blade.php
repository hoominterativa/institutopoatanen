...
<div id="lightbox-port101-1" class="lightbox-port101 row px-0 mx-auto" >
    <div class="lightbox-port101__content">
        <div class="row px-0 px-0 mx-0 w-100 h-100">
            <div class="lightbox-port101__description p-5 col-md-6 d-block">
                ...
                <h2 class="lightbox-port101__description__subtitle mb-0">Subtitulo</h2>
                ...
                <div class="lightbox-port101__description__paragraph">
                 ...
                 <a href="#" class="lightbox-port101__paragraph__cta transition d-flex justify-content-center align-items-center">
                    <img src="{{asset('storage/uploads/tmp/icon-general.svg')}}" alt="" class="lightbox-port101__paragraph__cta__icon me-3 transition">
                    CTA
                </a>
            </div>
