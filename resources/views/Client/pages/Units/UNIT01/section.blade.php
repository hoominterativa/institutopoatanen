<div id="UNIT01" class="unit01-page">
    <section class="container-fluid px-0">
        @if ($section)
            <header class="unit01-page__header">
                 <div class="container container--unit01-header">
                    @if ($section->title || $section->subtitle)
                        <h2 class="d-block text-center">
                            <span class="unit01-page__header__subtitle d-block text-uppercase">{{$section->subtitle}}</span>
                            <span class="unit01-page__header__title d-block">{{$section->title}}</span>
                            ...
                            <nav class="unit01-page__header__navigation__desktop">
                                <ul>
                                    @foreach ($categories as $category)
                                        <li><a href="{{route('unit01.category.page',['UNIT01UnitsCategory' => $category->slug])}}">{{$category->title}}</a></li>
                                    @endforeach
                                </ul>
                            </nav>
