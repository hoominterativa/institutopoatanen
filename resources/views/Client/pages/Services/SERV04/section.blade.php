<section id="SERV04" class="serv04 container-fluid" style="background-image: url({{asset('storage/uploads/tmp/image-box-white.jpg')}})">
    ...
    <main class="serv04__content">
        <div class="container">
            <div class="carousel-serv04 owl-carousel">
                <div class="serv04__box w-100">
                    <div class="serv04__box__content">
                        <a href="servicos" rel="next" class="link-full"></a>
                        ...
                        <div class="serv04__box__description">
                            <div class="serv04__box__image">
                                <img src="{{asset('storage/uploads/tmp/icon-general.svg')}}" alt="Logo" loading="lazy">
                            </div>
                            ...
                            <a rel="next" href="servicos" class="serv04__box__cta transition justify-content-center align-items-center">
            ...
            <a rel="next" href="servicos" class="serv04__cta transition justify-content-center align-items-center">
                <img src="{{asset('storage/uploads/tmp/icon-general.svg')}}" alt="Icone CTA" class="serv04__cta__icon me-3 transition">
                CTA
            </a>
        </div>
    </main>
