                ...
                @foreach ($services as $service)
                    <div class="serv02__item">
                        @if ($service->path_image_box)
                            <img src="{{ asset('storage/'.$service->path_image_box) }}" alt="{{$service->title_box}}" class="serv02__item__bg">
                        @endif
                        <div class="serv02__item__information">
                            @if ($service->path_image_icon_box)
                                <img src="{{ asset('storage/'.$service->path_image_icon_box) }}" alt="Ícone" class="serv02__item__information__icon">
                            @endif
                        ...
                        <a href="{{route('serv02.page.content',['SERV02Services' => $service->slug])}}" class="serv02__item__cta">
                            <img src="{{ asset('storage/uploads/tmp/icon-general.svg') }}" alt="Imagem de fundo" class="serv02__item__cta__icon">
                            CTA
                        </a>
                    </div>
                @endforeach
