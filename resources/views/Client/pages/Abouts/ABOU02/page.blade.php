...
<div id="ABOU02" class="abou02-page">
    <section class="container-fluid px-0">
        <header class="abou02-page__header" style="background-image: url({{asset('storage/uploads/tmp/bg-banner-inner.jpg')}})">
            <h2 class="container container--abou02-header d-flex flex-column justify-content-center align-items-center">
                <span class="abou02-page__header__title">Titulo do banner</span>
                <span class="abou02-page__header__subtitle mb-0">SUBTITULO</span>
        ...
        <div class="container container--abou02-page">
            <div class="abou02-page__content text-center">
                <h2 class="abou02-page__content__container d-flex flex-column">
                    <span class="abou02-page__content__subtitle">Subtitulo</span>
                    <span class="abou02-page__content__title mb-0">Titulo</span>
                </h2>
    ...
    <section class="abou02-page__topic container-fluid" style="background-image: url({{asset('storage/uploads/tmp/bg-section-dark-gray.jpg')}})">
        <div class="container container--abou02-page__topic">
            <h2 class="abou02-page__topic__encompass text-center d-flex flex-column">
                <span class="abou02-page__topic__encompass__title">Titulo</span>
                <span class="abou02-page__topic__encompass__subtitle mb-0">Subtitulo</span>
                            ...
                            <div class="abou02-page__topic__content transition w-100 h-100">
                                <div class="abou02-page__topic__header position-relative w-100 h-100">
                                    <div class="abou02-page__topic__image w-100 h-100">
                                        <img src="{{asset('storage/uploads/tmp/port01_path_image_box.png')}}" class="w-100 h-100" alt="">
                                    </div>
        ...
        <div class="container container--abou02-page__section">
            <div class="row abou02-page__section__row align-items-center">
                ...
                <div class="col-12 col-md-7 abou02-page__section__description">
                    <h2 class="abou02-page__section__encompass_title d-flex flex-column">
