    ...
    <div class="abou04-page" id="abou04-page">
        ...
        @if ($about)
            <section class="abou04-page__cont w-100">
                <main class="abou04-page__cont__main container">
                    @if ($about->path_image)
                        <img src="{{ asset('storage/' . $about->path_image) }}" alt=""
                            class="abou04-page__cont__image">
                    @endif
                ...
                <main class="abou04-page__gallery__main container d-flex flex-column align-items-center">
                    ...
                    @if ($sectionGallery->link_button)
                        <a href="{{ getUri($sectionGallery->link_button) }}"
                            target="{{ $sectionGallery->target_link_button }}" class="abou04-page__gallery__cta">
        ...
        @if ($sectionTopic)
            <section class="abou04-page__topics w-100"
                ...
                @if ($topics->count())
                    <div
                        class="abou04-page__topics__list container d-flex flex-wrap justify-content-start align-items-stretch ">
