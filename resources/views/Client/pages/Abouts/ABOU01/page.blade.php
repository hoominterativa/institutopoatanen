    ...
    @if ($about)
        <main id="root">
            <div id="ABOU01" class="abou01-page">
                ...
                @if ($topics->count())
                    <section class="abou01-page__topic container-fluid" style="background-image: url({{asset('storage/' . $section->path_image_topic_desktop)}}); background-color: {{$section->background_color_topic}};">
                        <div class="container">
                            ...
                            <div class="row abou01-page__section__row align-items-center">
                                <div class="abou01-page__section__image col-12 col-lg-5">
                                    @if ($section->path_image_content)
                                        <img src="{{asset('storage/'.$section->path_image_content)}}" class="abou01-page__section__image__item" width="430" alt="{{$section->title_content}}">
                                    @endif
                                </div>
                                <div class="col-12 col-lg-7">
                                    @if ($section->title_content || $section->subtitle_content)
                                        <h2 class="abou01-page__section__container">
                                            ...
                                            <span class="abou01-page__section__subtitle">{{$section->subtitle_content}}</span>
