...
<main id="root">
    <div id="abou05-page" class="abou05-page">
        <section class="container-fluid px-0">
            <header class="abou05-page__header" style="background-image: url()">
                <div class="container d-flex flex-column justify-content-center align-items-center">
                    <h3 class="abou05-page__header__container">
            ...
            <div class="container">
                <div class="abou05-page__content">
                    <h2 class="abou05-page__content__container">
                ...
                <div class="row abou05-page__section__row align-items-center">
                    <div class="abou05-page__section__box">
                        ...
                        <div class="col-12 col-md-7 abou05-page__section__box__description">
                                ...
                                <a href="#" class="abou05-page__section__box__description__cta transition justify-content-center align-items-center ms-auto">
