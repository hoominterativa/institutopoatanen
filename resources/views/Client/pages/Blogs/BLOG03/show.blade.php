...
{{-- BEGIN Page content --}}
<main id="root">
    <section id="BLOG03" class="blog03-show container-fluid">
        <div class="container">
            <div class="row justify-content-between">
                <div class="blog03-show__col-start col-12 col-sm-8">
                ...
                <div class="blog03-show__col-end col-12 col-sm-3">
                    <div class="blog03-show__related">
                        {{-- <a href="" class="blog03-show__related__share">Compartilhar Artigo</a> --}}
                        <h4 class="blog03-show__related__title">Artigos Relacionados</h4>
                        @foreach ($blogsRelated as $blogRelated)
                            <article class="blog03-show__boxs__item">
                                <div itemscope itemtype="http://schema.org/Article" class="blog03-show__boxs__item__content transition">
                                    <a itemprop="url" href="{{route('blog03.show.content', ['BLOG03BlogsCategory' => $blogRelated->category->slug, 'BLOG03Blogs' => $blogRelated->slug])}}">
                                        <figure class="blog03-show__boxs__item__image">
                                            <img itemprop="image" src="{{asset('storage/' . $blogRelated->path_image)}}" class="blog03-show__boxs__item__image__img" width="100%" alt="{{$blogRelated->title}}"/>
                                        </figure>
