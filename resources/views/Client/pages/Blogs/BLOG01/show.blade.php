...
@section('content')
    <main id="root" class="blog01-show">
        <section class="blog01-show__banner">
            <h2 class="blog01-show__banner__title">Notícias</h2>
        </section>
        ...
        <article itemscope itemtype="http://schema.org/Article" class="blog01-show__article">
            ...
            <button class="blog01-show__article__share">
                <span>
                    Compartilhar
                </span>
            </button>
            <dialog class="blog01-show__article__modal">
                ...
                <div class="blog01-show__article__modal__main">
                    <menu class="blog01-show__article__modal__main__socials">
                        <div class="blog01-show__article__modal__main__socials__swiper-wrapper swiper-wrapper">
                            <a class="blog01-show__article__modal__main__socials__item swiper-slide"
                                ...
                                <figure class="blog01-show__article__modal__main__socials__item__figure">
                                    ...
                                    <figcaption class="blog01-show__article__modal__main__socials__item__figure__title">
                                        Whatsapp
                                    </figcaption>
                                </figure>
                            </a>
                            ...
                            <a class="blog01-show__article__modal__main__socials__item swiper-slide" id="x"
                            ...
                            <a class="blog01-show__article__modal__main__socials__item swiper-slide" id="email"
        ...
        @if ($blogsRelated->count() > 0)
            <section class="blog01-show__related">
                <h3 class="blog01-show__related__title">Notícias relacionadas</h3>
