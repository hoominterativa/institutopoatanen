    ...
    <main id="root" class="blog01-show">
        ...
        <article itemscope itemtype="http://schema.org/Article" class="blog01-show__article">
            ...
            <dialog class="blog01-show__article__modal">
                ...
                <main class="blog01-show__article__modal__main">
                    <menu class="blog01-show__article__modal__main__socials">
                        {{-- <div class="blog01-show__article__modal__main__socials__swiper-wrapper swiper-wraper"> --}}
                        <a class="blog01-show__article__modal__main__socials__item" id="whatsapp" target="_blank">
                            <figure class="blog01-show__article__modal__main__socials__item__figure">
                                ...
                                <figcaption class="blog01-show__article__modal__main__socials__item__figure__title">Whatsapp
                                </figcaption>
                            </figure>
                        </a>
                        <a class="blog01-show__article__modal__main__socials__item" id="facebook" target="_blank">
                            <figure class="blog01-show__article__modal__main__socials__item__figure">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60" focusable="false"
                                    style="pointer-events: none; display: inherit;">
                                    <g fill="none" fill-rule="evenodd">
                                ...
                                <figcaption class="blog01-show__article__modal__main__socials__item__figure__title">Facebook
                                </figcaption>
                            </figure>
                        </a>
                        <a class="blog01-show__article__modal__main__socials__item" id="x" target="_blank">
                            <figure class="blog01-show__article__modal__main__socials__item__figure">
                                ...
                                <figcaption class="blog01-show__article__modal__main__socials__item__figure__title">X
                                </figcaption>
                            </figure>
                        </a>
                        <a class="blog01-show__article__modal__main__socials__item" id="email" target="_blank">
                            <figure class="blog01-show__article__modal__main__socials__item__figure">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60" focusable="false"
                                    style="pointer-events: none; display: inherit;">
                                ...
                                <figcaption class="blog01-show__article__modal__main__socials__item__figure__title">Email
                                </figcaption>
                            </figure>
                        </a>
                        {{-- </div> --}}
                    ...
                    <div class="blog01-show__article__modal__main__copy">
                        <p class="blog01-show__article__modal__main__copy__link"></p>
                        <button class="blog01-show__article__modal__main__copy__button">Copiar</button>
                    </div>
                </main>
            </dialog>
        </article>
        ...
        @if ($blogsRelated->count() > 0)
            <section class="blog01-show__related">
                ...
                <div class="blog01-show__related__carousel">
                        ...
                        @foreach ($blogsRelated as $blogRelated)
                            <article itemscope itemtype="http://schema.org/Article"
                                ...
                                <img itemprop="image" src="{{ asset('storage/' . $blogRelated->path_image_thumbnail) }}"
                                    ...
                                    alt="Imagem do artigo {{ $blogRelated->title }}" />
                                ...
                                <div class="blog01-show__related__item__description">
                                    ...
                                    <h4 itemprop="headline" class="blog01-show__related__item__description__title">
                    ...
                    <div class="blog01-show__related__carousel__swiper-pagination swiper-pagination"></div>
                </div>
